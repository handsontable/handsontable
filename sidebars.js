module.exports = {
  ...
  // apiReference: { // should be generated automatically
  //     Core:[
  //         {type: "category", label: "Core", items: []},
  //         {type: "category", label: "Hooks", items: []},
  //         {type: "category", label: "Options", items: []},
  //     ], Plugins: [
  //         {type: "category", label: "AutoColumnSize", items: []},
  //         {type: "category", label: "AutoRowSize", items: []},
  //         {type: "category", label: "Autofill", items: []},
  //         {type: "category", label: "BindRowsWithHeaders", items: []},
  //         {type: "category", label: "CollapsibleColumns", items: []},
  //         {type: "category", label: "ColumnSorting", items: []},
  //         {type: "category", label: "ColumnSummary", items: []},
  //         {type: "category", label: "Comments", items: []},
  //         {type: "category", label: "ContextMenu", items: []},
  //         {type: "category", label: "CopyPaste", items: []},
  //         {type: "category", label: "CustomBorders", items: []},
  //         {type: "category", label: "DragToScroll", items: []},
  //         {type: "category", label: "DropdownMenu", items: []},
  //         {type: "category", label: "ExportFile", items: []},
  //         {type: "category", label: "Filters", items: []},
  //         {type: "category", label: "Formulas", items: []},
  //         {type: "category", label: "HeaderTooltips", items: []},
  //         {type: "category", label: "HiddenColumns", items: []},
  //         {type: "category", label: "HiddenRows", items: []},
  //         {type: "category", label: "ManualColumnFreeze", items: []},
  //         {type: "category", label: "ManualColumnMove", items: []},
  //         {type: "category", label: "ManualColumnResize", items: []},
  //         {type: "category", label: "ManualRowMove", items: []},
  //         {type: "category", label: "ManualRowResize", items: []},
  //         {type: "category", label: "MergeCells", items: []},
  //         {type: "category", label: "MultiColumnSorting", items: []},
  //         {type: "category", label: "NestedHeaders", items: []},
  //         {type: "category", label: "NestedRows", items: []},
  //         {type: "category", label: "ObserveChanges", items: []},
  //         {type: "category", label: "PersistentState", items: []},
  //         {type: "category", label: "Search", items: []},
  //         {type: "category", label: "TrimRows", items: []},
  //         {type: "category", label: "UndoRedo", items: []},
  //     ]
  // }
};
