...
(function($){
  ...
  autoResize.resizableFilterSelector = 'textarea,input:not(input[type]),input[type=text],input[type=password],input[type=number]';
    ...
    check: function(e, immediate) {
      ...
      if (newWidth || scrollTop) {
        ...
        if (config.animate && !immediate) {
          ...
          el.width(newWidth).height(scrollTop);
        }
      }
      return;
    },
