...
- Fixed a problem with table size, selection border widths, and header background sizes not being set correctly underneath a scale transform. [#6201](https://github.com/handsontable/handsontable/issues/6201)
...
- Fixed an issue where the `maxRows` nad `maxCols` options interfered with hidden index calculations. [#7350](https://github.com/handsontable/handsontable/issues/7350)
