...
export function arrayReduce(array: any[], iteratee: (value: any, index: number, array: any[]) => void, accumulator: any, initFromArray: boolean): any;
...
export function getDifferenceOfArrays(...arrays: (string | number)[][]): string[] | number[];
export function getIntersectionOfArrays(...arrays: (string | number)[][]): string[] | number[];
export function getUnionOfArrays(...arrays: (string | number)[][]): string[] | number[];
