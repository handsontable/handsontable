...
export function addEvent(element: HTMLElement, event: string, callback: Function): void;
export function removeEvent(element: HTMLElement, event: string, callback: Function): void;
