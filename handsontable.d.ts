 ...
 */
  ...
  namespace Hooks {
    ...
    interface Events {
      ...
      afterListen?: () => void;
      afterLoadData?: (sourceData: Handsontable.CellValue[], initialLoad: boolean, source: string) => void;
      ...
      beforeLoadData?: (sourceData: Handsontable.CellValue[], initialLoad: boolean, source: string) => void;
