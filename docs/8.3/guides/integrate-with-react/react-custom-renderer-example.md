...
const hotSettings = {
  data:
    [
      ['A1', 'https://handsontable.com/docs/8.3/img/examples/professional-javascript-developers-nicholas-zakas.jpg'],
      ['A2', 'https://handsontable.com/docs/8.3/img/examples/javascript-the-good-parts.jpg']
    ],
  columns: [
    {},
    {
