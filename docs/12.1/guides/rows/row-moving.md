...
<ImageVersioned src="/docs/12.1/img/drag_action.svg" alt="dragRows method">
...
<ImageVersioned src="/docs/12.1/img/move_action.svg" alt="moveRows method">
