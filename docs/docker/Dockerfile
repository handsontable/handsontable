...
# The symlink points to the outside file system, so it needs to be removed.
RUN rm /app/docs/.vuepress/public/handsontable

# Instead, copy the Handsontable files into the image.
