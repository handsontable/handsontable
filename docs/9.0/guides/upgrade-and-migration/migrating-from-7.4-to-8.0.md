...
<ImageVersioned src="/docs/9.0/img/drag_action.svg" alt="drag_action" />
...
<ImageVersioned src="/docs/9.0/img/move_action.svg" alt="move_action" />
...
<ImageVersioned src="/docs/9.0/img/spare_before_8.svg" alt="before_8" />

The results after:

<ImageVersioned src="/docs/9.0/img/spare_after_8.svg" alt="after_8" />
...
<ImageVersioned src="/docs/9.0/img/LMB_was.gif" alt="LMB_was" />

Now the expected behavior is to select all cells:

<ImageVersioned src="/docs/9.0/img/LMB_is.gif" alt="LMB_is" />
