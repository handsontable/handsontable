...
const integrateWithReactItems = [
  ...
  { path: 'guides/integrate-with-react/react-setting-up-a-locale' },
...
const integrateWithAngularItems = [
  ...
  { path: 'guides/integrate-with-angular/angular-setting-up-a-locale' },
...
const integrateWithVueItems = [
  ...
  { path: 'guides/integrate-with-vue/vue-setting-up-a-locale' },
...
const accessoriesAndMenusItems = [
  ...
  { path: 'guides/accessories-and-menus/keyboard-navigation' },
...
const internationalizationItems = [
  { path: 'guides/internationalization/internationalization-i18n' },
  // TODO { path: 'guides/internationalization/rtl' },
...
const advancedTopicsItems = [
  // TODO { path: 'guides/advanced-topics/accessibility' },
