...
To use HyperFormula independently from Handsontable (e.g. to build a custom Handsontable plugin), you need to purchase a separate [HyperFormula license key](https://handsontable.com/get-a-quote)).
:::
