...
const frameworkPartialPath = getEnvDocsFramework() ? `${getEnvDocsFramework()}${FRAMEWORK_SUFFIX}/` : '';
...
const base = isFirstShownOrMultiVersion ? '/docs/' : `/docs/${versionPartialPath}${frameworkPartialPath}`;
