...
// might be exclude from this file, however I want to reduce HTTP requests
// TODO this file is quite similar to examples/dependencies.js,
//  However be careful because some dependencies have different URLs!
//  That URLs might be stored as JSON - to research further.
const { buildDependencyGetter, dependencyPresetMap } = (() => {
  ...
  return {
    buildDependencyGetter: buildGetter,
    dependencyPresetMap: presetMap
  };
})();
...
const useHandsontable = ((instanceRegister) => {
  ...
  return (version, callback = () => {}, preset = 'hot') => {
    ...
    const loadPreset = async() => {
      const dependencies = dependencyPresetMap[preset];
