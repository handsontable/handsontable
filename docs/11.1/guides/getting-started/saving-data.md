...
const hot = new Handsontable(container, {
  ...
  afterChange: function (change, source) {
    ...
    ajax('/docs/11.1/scripts/json/save.json', 'GET', JSON.stringify({ data: change }), data => {
...
Handsontable.dom.addEvent(save, 'click', () => {
  ...
  ajax('/docs/11.1/scripts/json/save.json', 'GET', JSON.stringify({ data: hot.getData() }), res => {
