...
permalink: /8.4/keyboard-navigation
...
| <kbd>Ctrl</kbd> + <kbd>C</kbd>  | <kbd>Cmd</kbd> + <kbd>C</kbd> | Copy cell's content |
| <kbd>Ctrl</kbd> + <kbd>X</kbd> | <kbd>Cmd</kbd> + <kbd>X</kbd> | Cut cell's content |
| <kbd>Ctrl</kbd> + <kbd>V</kbd>  | <kbd>Cmd</kbd> + <kbd>V</kbd> | Paste cell's content |
