...
You can set Handsontable to correct such invalid dates, so they match the required format. To do this, set the [`correctFormat`](@/api/options.md#correctformat) option to `true`. For example:
