...
| <kbd>Tab</kbd> | <kbd>Tab</kbd> | Move to the next cell (normally on the right side, unless the [layout direction](@/guides/accessories-and-menus/searching-values.md) is RTL) |
| <kbd>Shift</kbd> + <kbd>Tab</kbd> | <kbd>Shift</kbd> + <kbd>Tab</kbd> | Move to the previous cell (normally on the left side, unless the [layout direction](@/guides/accessories-and-menus/searching-values.md) is RTL) |
