...
| <kbd>Ctrl</kbd> + <kbd>Enter</kbd>                                           | <kbd>Ctrl</kbd>/<kbd>Cmd</kbd> + <kbd>Enter</kbd> | Edit the current cell<br><br>When editing, with a single cell selected:<br>add a new line inside the cell<br><br>When editing, with multiple cells selected:<br>fill all currently-selected cells with the contents of the currently-edited cell |
| <kbd>Alt</kbd> + <kbd>Enter</kbd>                                            | <kbd>Option</kbd> + <kbd>Enter</kbd>              | Edit the current cell<br><br>When editing, with a single cell selected:<br>add a new line inside the cell<br><br>When editing, with multiple cells selected:<br>add a new line inside the currently-edited cell                                  |
