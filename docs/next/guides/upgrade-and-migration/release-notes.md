...
- Data stored by the [`NestedRow`](@/api/nestedrows.md) plugin  won't be corrupted by some actions [#8180](https://github.com/handsontable/handsontable/issues/8180)
...
- Fixed a bug where not providing a data object with the [`NestedRow`](@/api/nestedrows.md) plugin  enabled crashed the table. [#8171](https://github.com/handsontable/handsontable/issues/8171)
...
* Fixed a bug where an attempt to move collapsed parent rows, with the [`NestedRow`](@/api/nestedrows.md) plugin  enabled, resulted in an error. ([#7132](https://github.com/handsontable/handsontable/issues/7132))
...
* Fixed an issue with moving rows to the last row of the table when the [`NestedRow`](@/api/nestedrows.md) plugin  was enabled. Repaired some other minor moving-related bugs as well. ([#6067](https://github.com/handsontable/handsontable/issues/6067))
...
* When the [`NestedRow`](@/api/nestedrows.md) plugin  is `enabled`, moving rows will be possible only using the UI or by calling the `dragRows` method of the `manualRowMove` plugin.
...
* When the [`NestedRow`](@/api/nestedrows.md) plugin  is `enabled`, moving rows will be possible only using the UI or by calling the `dragRows` method of the `manualRowMove` plugin. [#5945](https://github.com/handsontable/handsontable/pull/5945)
...
* Fixed a problem, where it was impossible to filter the data declared in the [`NestedRow`](@/api/nestedrows.md) plugin . [#5889](https://github.com/handsontable/handsontable/issues/5889)
...
* Fixed a bug, where detaching a child from a parent in the [`NestedRow`](@/api/nestedrows.md) plugin  would cause a \`+/-\` button misalignment. [#5900](https://github.com/handsontable/handsontable/issues/5900)
...
* Fixed a bug, where moving children between parents using the [`NestedRow`](@/api/nestedrows.md) plugin  would throw an error. [#6066](https://github.com/handsontable/handsontable/issues/6066)
* Fixed a bug, where adding rows by modifying the data by reference while using the [`NestedRow`](@/api/nestedrows.md) plugin  would throw an error. [#3914](https://github.com/handsontable/handsontable/issues/3914)
