...
**Changed**
- **Breaking change**: Changed how default keyboard shortcuts are defined, to improve keyboard navigation consistency. Now, nearly all default keyboard shortcuts are defined explicitly, and are properly documented. Most keyboard shortcuts that were not defined explicitly don't work anymore (e.g., <kbd>Enter</kbd> opens a cell's editor, but <kbd>Ctrl</kbd> + <kbd>Enter</kbd> doesn't). This change doesn't affect custom keyboard shortcuts. [#8942](https://github.com/handsontable/handsontable/issues/8942)
