...
But each project has its own [building](#building-processes) and [testing](@/guides/building-and-tooling/testing.md) processes.
...
- [Packages](@/guides/building-and-tooling/packages.md)
- [Testing](@/guides/building-and-tooling/testing.md)