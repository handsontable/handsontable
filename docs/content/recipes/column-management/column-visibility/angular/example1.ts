...
export class Example1ColumnVisibilityComponent {
...
import { Example1ColumnVisibilityComponent } from './app.component';
...
@NgModule({
  ...
  declarations: [Example1ColumnVisibilityComponent],
  providers: [...appConfig.providers],
  bootstrap: [Example1ColumnVisibilityComponent],
})
