...
export class Example1ImportCsvExcelComponent {
...
import { Example1ImportCsvExcelComponent } from './app.component';
...
@NgModule({
  ...
  declarations: [Example1ImportCsvExcelComponent],
  providers: [...appConfig.providers],
  bootstrap: [Example1ImportCsvExcelComponent],
})
