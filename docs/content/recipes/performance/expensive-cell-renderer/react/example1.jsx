...
const ExampleComponent = () => {
    ...
    return (<div>
      ...
      <HotTable ref={hotRef} data={data} colHeaders={['ID', 'Customer', 'Region', 'Trend (12 months)']} columns={COLUMNS} rowHeaders={true} height={320} width="100%" autoWrapRow={true} licenseKey="non-commercial-and-evaluation" afterViewRender={handleAfterViewRender}/>
