...
export class Example1AriaGridComponent {
...
import { Example1AriaGridComponent } from './app.component';
...
@NgModule({
  ...
  declarations: [Example1AriaGridComponent],
  providers: [...appConfig.providers],
  bootstrap: [Example1AriaGridComponent],
})
