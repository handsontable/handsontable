...
export class Example1AutoSaveBackendComponent {
...
import { Example1AutoSaveBackendComponent } from './app.component';
...
@NgModule({
  ...
  declarations: [Example1AutoSaveBackendComponent],
  providers: [...appConfig.providers],
  bootstrap: [Example1AutoSaveBackendComponent],
})
