...
export class Example1ServerSideNestjsComponent {
...
import { Example1ServerSideNestjsComponent } from './app.component';
...
@NgModule({
  ...
  declarations: [Example1ServerSideNestjsComponent],
  providers: [...appConfig.providers],
  bootstrap: [Example1ServerSideNestjsComponent],
})
