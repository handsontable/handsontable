const accessibilityItems = [
  { path: 'accessibility/keyboard-shortcuts/keyboard-shortcuts', title: 'Custom keyboard shortcuts', onlyFor: ['javascript'] },
];
...
module.exports = {
  sidebar: [
    'introduction',
    { title: 'Accessibility & UX', path: 'accessibility', children: accessibilityItems, collapsable: false, onlyFor: ['javascript'] },
