...
export const data = [
  { product: "Dashboard Pro", category: "Analytics", version: "3.2.0", releaseDate: "2025-03-15", status: "Released", downloads: 12450 },
  { product: "Form Builder", category: "Tools", version: "2.1.0", releaseDate: "2025-04-22", status: "Released", downloads: 8320 },
  { product: "Chart Engine", category: "Analytics", version: "4.0.0", releaseDate: "2025-06-10", status: "Beta", downloads: 3100 },
  { product: "Auth Module", category: "Security", version: "1.5.2", releaseDate: "2025-07-01", status: "Released", downloads: 15600 },
  { product: "File Manager", category: "Storage", version: "2.0.0", releaseDate: "2025-08-18", status: "Planned", downloads: 0 },
  { product: "Email Service", category: "Communication", version: "3.1.0", releaseDate: "2025-09-05", status: "Released", downloads: 9870 },
  { product: "Search Index", category: "Tools", version: "1.2.0", releaseDate: "2025-10-12", status: "Beta", downloads: 2450 },
  { product: "Cache Layer", category: "Infra", version: "2.3.1", releaseDate: "2025-11-28", status: "Planned", downloads: 0 },
];
...
> = {
  ...
  editor: editorFactory<{
    ...
    init(editor) {
       ...
       */
      editor._darkThemeLink = editor.hot.rootDocument.createElement(
        "LINK",
      ) as HTMLLinkElement;
      editor._darkThemeLink.rel = "stylesheet";
      editor._darkThemeLink.href =
    ...
    afterOpen(editor) {
      const isDark =
        editor.hot.rootDocument.documentElement.getAttribute("data-theme") ===
        "dark";
