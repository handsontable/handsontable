...
Read the [Simplified Custom Cell Definitions guide](@/guides/cell-functions/custom-cells/custom-cells.md) first to understand the modern factory-based approach for creating custom cells. This approach reduces complexity while maintaining full access to Handsontable's features.
