...
export class Example1MomentTimeComponent {
  readonly data = [
    {
      itemName: 'Lunar Core',
      category: 'Lander',
...
import { Example1MomentTimeComponent } from './app.component';
...
@NgModule({
  ...
  declarations: [Example1MomentTimeComponent],
  providers: [...appConfig.providers],
  bootstrap: [Example1MomentTimeComponent],
})
