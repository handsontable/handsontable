...
@[code](@/content/guides/formulas/formula-calculation/example1.css)
...
@[code](@/content/guides/formulas/formula-calculation/example1.jsx)
...
@[code](@/content/guides/formulas/formula-calculation/example.jsx)
