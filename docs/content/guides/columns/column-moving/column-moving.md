...
@[code](@/content/guides/columns/column-moving/example1.jsx)
...
@[code](@/content/guides/columns/column-moving/example2.jsx)
...
@[code](@/content/guides/columns/column-moving/example3.jsx)
