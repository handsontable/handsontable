...
const ExampleComponent = () => {
    return (<HotTable data={[
        ...
        ]} width="100%" height="auto" colHeaders={[
            'Symbol',
            'Atomic Number',
            'Name',
            'Group',
            ...
            'Electronegativity',
            'Atomic Radius (pm)',
        ]} rowHeaders={true} colWidths={[30, 40, 50, 60, 90, 90, 90, 90, 90, 90]} manualColumnResize={true} autoWrapRow={true} autoWrapCol={true} licenseKey="non-commercial-and-evaluation"/>);
};
