...
const ExampleComponent = () => {
    return (<HotTable data={[
        ...
        ]} width="100%" height="auto" colWidths={80} colHeaders={true} rowHeaders={true} stretchH="last" contextMenu={true} autoWrapRow={true} autoWrapCol={true} licenseKey="non-commercial-and-evaluation"/>);
};
