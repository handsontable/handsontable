...
@[code](@/content/guides/getting-started/configuration-options/example1.jsx)
...
@[code](@/content/guides/getting-started/configuration-options/example2.jsx)
...
@[code](@/content/guides/getting-started/configuration-options/example3.jsx)
...
@[code](@/content/guides/getting-started/configuration-options/example4.jsx)
...
@[code](@/content/guides/getting-started/configuration-options/example5.js)
...
@[code](@/content/guides/getting-started/configuration-options/example6.jsx)
