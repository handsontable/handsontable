...
description: Fill the data grid with various data structures, including an array of arrays or arrays of objects, using Handsontable's configuration options or API methods.
