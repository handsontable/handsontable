...
// =============================================================================
// In-memory "server" — catalog, filters, CRUD, optional failed fetch for the
// demo buttons. Replace this factory with API clients (fetch / GraphQL) in a
// real app.
// =============================================================================
...
/**
 * @type {ReadonlyArray<{ id: number, product: string, sku: string, category: string, unitPrice: number, inStock: number }>}
 */
const SEED_CATALOG = [
...
/**
 * @param {unknown} cell
 * @param {{ name?: string, args?: unknown[] }} cond
 * @returns {boolean}
 */
 ...
 * @param {Array<{ prop: string, operation?: string, conditions?: Array<{ name?: string, args?: unknown[] }> }>|null} filters
...
/**
 * @returns {object} DataProvider callbacks plus fetch failure toggles for the demo toolbar.
 */
...
// =============================================================================
// Grid — Handsontable options, hooks, and demo toolbar wiring.
// =============================================================================
