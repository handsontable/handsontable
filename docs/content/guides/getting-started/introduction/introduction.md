...
Are you using React? [Explore the React version](@/react/guides/getting-started/introduction/introduction.md) of this documentation.
...
- [Install Handsontable](@/guides/getting-started/installation/installation.md)
- [Load data](@/guides/getting-started/binding-to-data/binding-to-data.md)
- [Save data](@/guides/getting-started/saving-data/saving-data.md)
- [Configure options](@/guides/getting-started/configuration-options/configuration-options.md)
- [Define the size](@/guides/getting-started/grid-size/grid-size.md)
