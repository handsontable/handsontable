...
@[code](@/content/guides/cell-features/clipboard/example1.jsx)
...
@[code](@/content/guides/cell-features/clipboard/example3.jsx)
...
@[code](@/content/guides/cell-features/clipboard/example2.jsx)
