...
const ExampleComponent = () => {
    return (<HotTable data={[
        ...
        ]} colHeaders={['Task', 'Owner', 'Tracker', 'Contact', 'Notes']} colWidths={[180, 120, 260, 220, 320]} height="auto" autoLink={true} autoWrapRow={true} autoWrapCol={true} licenseKey="non-commercial-and-evaluation"/>);
};
