...
@[code](@/content/guides/cell-features/selection/example1.jsx)
...
@[code](@/content/guides/cell-features/selection/example2.jsx)
...
```
@[code](@/content/guides/cell-features/selection/example3.css)
```js
import Handsontable from 'handsontable';
import 'handsontable/dist/handsontable.full.min.css';
...
```
@[code](@/content/guides/cell-features/selection/example3.jsx)
