...
@[code](@/content/guides/cell-features/formatting-cells/example1.css)
...
@[code](@/content/guides/cell-features/formatting-cells/example1.jsx)
...
@[code](@/content/guides/cell-features/formatting-cells/example2.jsx)
...
@[code](@/content/guides/cell-features/formatting-cells/example3.jsx)
