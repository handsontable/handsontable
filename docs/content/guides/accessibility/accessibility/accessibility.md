...
@[code](@/content/guides/accessibility/accessibility/example1.html)

@[code](@/content/guides/accessibility/accessibility/example1.css)

@[code](@/content/guides/accessibility/accessibility/example1.js)
...
@[code](@/content/guides/accessibility/accessibility/example2.css)

@[code](@/content/guides/accessibility/accessibility/example2.jsx)
