...
const handleCheckboxChange = (checkboxName: string) => {
  const current = toggleableOptions.value;

  switch (checkboxName) {
    case 'enable-tab-navigation':
      toggleableOptions.value = { ...current, tabNavigation: !current.tabNavigation };
      break;
    case 'enable-header-navigation':
      toggleableOptions.value = { ...current, navigableHeaders: !current.navigableHeaders };
      break;
    case 'enable-cell-virtualization':
      toggleableOptions.value = {
        ...current,
        renderAllRows: !current.renderAllRows,
        renderAllColumns: !current.renderAllColumns,
      };
      break;
    case 'enable-cell-enter-editing':
      toggleableOptions.value = { ...current, enterBeginsEditing: !current.enterBeginsEditing };
      break;
    case 'enable-arrow-rl-first-last-column':
      toggleableOptions.value = { ...current, autoWrapRow: !current.autoWrapRow };
      break;
    case 'enable-arrow-td-first-last-column':
      toggleableOptions.value = { ...current, autoWrapCol: !current.autoWrapCol };
      break;
    case 'enable-enter-focus-editing':
      toggleableOptions.value = {
        ...current,
        enterMoves: current.enterMoves.row !== 1 ? { col: 0, row: 1 } : { col: 0, row: 0 },
      };
      break;
    default:
      break;
...
<template>
  <div id="example2" class="example-container">
    <div class="checkbox-container">
      <div>
        <label class="option-label" for="enable-tab-navigation" id="tab-navigation-label">
          <input
            :checked="toggleableOptions.tabNavigation"
            type="checkbox"
            id="enable-tab-navigation"
            name="enable-tab-navigation"
            aria-label="Enable navigation with the Tab key"
            @change="handleCheckboxChange('enable-tab-navigation')"
          />
          Enable navigation with the Tab key
        </label>
        <a
          href="https://handsontable.com/docs/vue-data-grid/api/options/#tabnavigation"
          target="_blank"
          class="external-link"
      ...
      <div>
        <label class="option-label" for="enable-header-navigation" id="header-navigation-label">
          <input
            :checked="toggleableOptions.navigableHeaders"
            type="checkbox"
            id="enable-header-navigation"
            name="enable-header-navigation"
            aria-labelledby="header-navigation-label"
            @change="handleCheckboxChange('enable-header-navigation')"
          />
          Enable navigation across headers
        </label>
        <a
          href="https://handsontable.com/docs/vue-data-grid/api/options/#navigableheaders"
          target="_blank"
          class="external-link"
          rel="noopener noreferrer"
      ...
      <div>
        <label class="option-label" for="enable-cell-virtualization" id="cell-virtualization-label">
          <input
            :checked="!toggleableOptions.renderAllRows"
            type="checkbox"
            id="enable-cell-virtualization"
            name="enable-cell-virtualization"
            aria-labelledby="cell-virtualization-label"
            @change="handleCheckboxChange('enable-cell-virtualization')"
          />
          Enable cells virtualization
        </label>
        <a
          href="https://handsontable.com/docs/vue-data-grid/api/options/#renderAllRows"
          target="_blank"
          class="external-link"
          rel="noopener noreferrer"
      ...
      <div>
        <label class="option-label" for="enable-cell-enter-editing" id="cell-enter-editing-label">
          <input
            :checked="toggleableOptions.enterBeginsEditing"
            type="checkbox"
            id="enable-cell-enter-editing"
            name="enable-cell-enter-editing"
            aria-labelledby="cell-enter-editing-label"
            @change="handleCheckboxChange('enable-cell-enter-editing')"
          />
          The Enter key begins cell editing
        </label>
        <a
          href="https://handsontable.com/docs/vue-data-grid/api/options/#enterbeginsediting"
          target="_blank"
          class="external-link"
          rel="noopener noreferrer"
      ...
      <div>
        <label class="option-label" for="enable-arrow-rl-first-last-column" id="arrow-rl-first-last-column-label">
          <input
            :checked="toggleableOptions.autoWrapRow"
            type="checkbox"
      ...
      <div>
        <label class="option-label" for="enable-arrow-td-first-last-column" id="arrow-td-first-last-column-label">
          <input
            :checked="toggleableOptions.autoWrapCol"
            type="checkbox"
      ...
      <div>
        <label class="option-label" for="enable-enter-focus-editing" id="enter-focus-editing-label">
          <input
            :checked="toggleableOptions.enterMoves.row !== 0"
            type="checkbox"
            id="enable-enter-focus-editing"
            name="enable-enter-focus-editing"
            aria-labelledby="enter-focus-editing-label"
            @change="handleCheckboxChange('enable-enter-focus-editing')"
          />
          The Enter key moves the focus after cell edition
        </label>
        <a
          href="https://handsontable.com/docs/vue-data-grid/api/options/#entermoves"
          target="_blank"
          class="external-link"
          rel="noopener noreferrer"
    ...
    <input class="placeholder-input" type="text" placeholder="Focusable text input" />
    ...
    >
      ...
      <HotColumn data="qty" type="numeric" header-class-name="htRight" />
