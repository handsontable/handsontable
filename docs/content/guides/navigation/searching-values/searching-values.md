...
@[code](@/content/guides/navigation/searching-values/example1.jsx)
...
`@[code](@/content/guides/navigation/searching-values/example2.css)`
```html
<div class="controls">
...
````
@[code](@/content/guides/navigation/searching-values/example2.jsx)
...
@[code](@/content/guides/navigation/searching-values/example3.jsx)
...
@[code](@/content/guides/navigation/searching-values/example4.jsx)
