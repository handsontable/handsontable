...
For more advanced actions, see the [list of all built-in shortcuts](@/guides/navigation/keyboard-shortcuts.md#default-keyboard-shortcuts), or add
shortcuts of [your own](@/guides/navigation/keyboard-shortcuts.md#custom-keyboard-shortcuts).
