...
import { Component, ViewChild, AfterViewInit, OnDestroy, ChangeDetectorRef, inject } from '@angular/core';
        ...
        <table class="debug-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><code>{{ focusScope }}</code></td>
            </tr>
            <tr>
              <td>
                <code>getShortcutManager().getActiveContextName()</code>
              </td>
              <td><code>{{ shortcutsContext }}</code></td>
            </tr>
          </tbody>
        </table>
      </div>
