...
function clearCurrentPageData() {
  const hotInstance = (hotRef.value as any)?.hotInstance;
...
<template>
  <div id="example5">
    <div class="example-controls-container">
      <div class="controls">
        <button @click="clearCurrentPageData">Clear the second column of the current page</button>
      </div>
    </div>
