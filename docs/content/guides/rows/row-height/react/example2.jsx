...
const ExampleComponent = () => {
    return (<HotTable data={[
        ...
        ]} width="100%" height="auto" colHeaders={true} rowHeaders={true} minRowHeights={[40, 40, 40, 40]} manualRowResize={true} autoWrapRow={true} autoWrapCol={true} licenseKey="non-commercial-and-evaluation"/>);
};
