...
const ExampleComponent = () => {
    return (<HotTable data={[
        ...
        ]} height="auto" colHeaders={true} rowHeaders={true} minRowHeights={40} manualRowResize={true} autoWrapRow={true} autoWrapCol={true} licenseKey="non-commercial-and-evaluation"/>);
};
