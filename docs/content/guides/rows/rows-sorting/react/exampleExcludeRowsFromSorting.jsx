...
const ExampleComponent = () => {
    return (<HotTable data={products} columns={[
        ...
        ]} colHeaders={['Product', 'Price', 'In stock']} height="auto" stretchH="all" columnSorting={true} 
    ...
    cells={(row) => (products[row]?.featured ? { className: 'featured-product' } : {})} licenseKey="non-commercial-and-evaluation"/>);
};
