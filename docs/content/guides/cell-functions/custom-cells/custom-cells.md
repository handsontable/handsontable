...
4. **[Feedback Editor](@/recipes/cell-types/feedback/feedback.md)** - Emoji feedback buttons using `factoryEditor`
2. **[Flatpickr Date Picker](@/recipes/cell-types/flatpickr/flatpickr.md)** - Advanced date picker with options using `factoryEditor`
3. **[Pikaday Date Picker](@/recipes/cell-types/pikaday/pikaday.md)** - Integrate Pikaday date picker using `factoryEditor`
