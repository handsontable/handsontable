...
@[code](@/content/guides/integrate-with-vue/vue-custom-id-class-style/example1.html)

@[code](@/content/guides/integrate-with-vue/vue-custom-id-class-style/example1.js)
