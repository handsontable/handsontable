...
@[code](@/content/guides/integrate-with-vue3/vue3-setting-up-a-language/example1.html)

@[code](@/content/guides/integrate-with-vue3/vue3-setting-up-a-language/example1.js)
