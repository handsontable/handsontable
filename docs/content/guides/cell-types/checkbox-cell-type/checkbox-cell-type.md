...
@[code](@/content/guides/cell-types/checkbox-cell-type/example1.jsx)
...
@[code](@/content/guides/cell-types/checkbox-cell-type/example2.jsx)
...
@[code](@/content/guides/cell-types/checkbox-cell-type/example3.jsx)
