...
- As a decimal separator, use the dot (`50.5`). You can also use the comma (`50,5`), but not at Handsontable's [initialization](@/guides/getting-started/installation.md#initialize-handsontable).
