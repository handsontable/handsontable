...
@[code](@/content/guides/cell-types/autocomplete-cell-type/example1.jsx)
...
@[code](@/content/guides/cell-types/autocomplete-cell-type/example2.jsx)
...
@[code](@/content/guides/cell-types/autocomplete-cell-type/example3.jsx)
