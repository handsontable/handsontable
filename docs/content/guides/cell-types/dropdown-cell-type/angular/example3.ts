...
export class Example3DropdownCellTypeComponent {
...
import { Example3DropdownCellTypeComponent } from './app.component';
...
@NgModule({
  ...
  declarations: [ Example3DropdownCellTypeComponent ],
  providers: [...appConfig.providers],
  bootstrap: [ Example3DropdownCellTypeComponent ]
})
