...
export class Example2DropdownCellTypeComponent {
...
import { Example2DropdownCellTypeComponent } from './app.component';
...
@NgModule({
  ...
  declarations: [ Example2DropdownCellTypeComponent ],
  providers: [...appConfig.providers],
  bootstrap: [ Example2DropdownCellTypeComponent ]
})
