...
const ExampleComponent = () => {
    return (<HotTable data={data} colHeaders={['Task', 'Deadline', 'Created']} columns={[
            { type: 'text', data: 'task' },
            {
                type: 'intl-datetime',
                data: 'deadline',
        ...
        ]} columnSorting={true} filters={true} dropdownMenu={true} height="auto" autoWrapRow={true} autoWrapCol={true} licenseKey="non-commercial-and-evaluation"/>);
};
