...
const ExampleComponent = () => {
    return (<HotTable data={data} colHeaders={['Task', 'Assignee', 'Deadline', 'Created']} columns={[
        ...
        ]} afterGetColHeader={(col, TH) => TH.classList.add('htLeft')} columnSorting={true} filters={true} dropdownMenu={true} stretchH="all" height="auto" autoWrapRow={true} autoWrapCol={true} licenseKey="non-commercial-and-evaluation"/>);
};
