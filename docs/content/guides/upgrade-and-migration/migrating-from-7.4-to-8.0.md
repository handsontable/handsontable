...
![drag_action]($withBase('/img/drag_action.svg'))
...
![move_action]($withBase('/img/move_action.svg'))
...
![before_8]($withBase('/img/spare_before_8.svg'))

The results after:

![after_8]($withBase('/img/spare_after_8.svg'))
...
![LMB_was]($withBase('/img/LMB_was.gif'))

Now the expected behavior is to select all cells:

![LMB_is]($withBase('/img/LMB_is.gif'))
