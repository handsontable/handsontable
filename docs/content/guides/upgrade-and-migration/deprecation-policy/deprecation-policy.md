...
| `registerShortcuts()` (`Formulas`) | 18.2 | 19.0 | No-op. The `Alt`+`Enter` shortcut that opens a cell's link is a core grid shortcut. Remove the call. | -- |
| `unregisterShortcuts()` (`Formulas`) | 18.2 | 19.0 | No-op. The `Alt`+`Enter` shortcut that opens a cell's link is a core grid shortcut. Remove the call. | -- |
