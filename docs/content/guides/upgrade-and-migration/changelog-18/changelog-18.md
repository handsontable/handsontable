...
- Added the [`colorScheme`](@/api/options.md#colorscheme) and [`density`](@/api/options.md#density) options, which set the color scheme and the spacing of the grid without declaring a theme. [#13205](https://github.com/handsontable/handsontable/pull/13205)
