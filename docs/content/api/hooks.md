...
| Param | Type | Description |
| --- | --- | --- |
| changes | `Array<Array>` <br/> `null` | 2D array containing information about each of the edited cells                               `[[row, prop, oldVal, newVal], ...]`, or `null` for the `"loadData"`                               and `"updateData"` sources. `row` is a visual row index. `prop` is a property name,                               a column index, or – when [`columns[].data`](@/api/options.md#columns) is a function –                               the column accessor function. To resolve a visual column index from `prop`, call                               [`propToCol()`](@/api/core.md#proptocol). Unlike                               [`beforeValidate`](@/api/hooks.md#beforevalidate) and                               [`afterValidate`](@/api/hooks.md#aftervalidate), this hook passes the accessor function                               as `prop` so the grid can write data back. Read more:                               [Binding to data: Identify changed columns in hooks](@/guides/getting-started/binding-to-data/binding-to-data.md#identify-changed-columns-in-hooks). |
...
::: ask-about-api afterCustomBordersUpdate|Hooks
...
_afterCustomBordersUpdate_

Fired by the [CustomBorders](@/api/customBorders.md) plugin after all custom borders from the configuration have
...
::: ask-about-api afterMoveCells|Hooks
...
_afterMoveCells(sourceRange, targetRange, isCopy)_
...
| Param | Type | Description |
| --- | --- | --- |
| sourceRange | `CellRange` | The original range. |
| targetRange | `CellRange` | The range the data was moved to. |
| isCopy | `boolean` | `true` when the operation was a copy. |
...
::: ask-about-api afterOnSelectionEdgeMouseDown|Hooks
...
_afterOnSelectionEdgeMouseDown(event, edge)_
...
| edge | `'top'` <br/> `'bottom'` <br/> `'start'` <br/> `'end'` | The pressed edge. |



### afterOnSelectionHandleMouseDown

::: ask-about-api afterOnSelectionHandleMouseDown|Hooks
...
_afterOnSelectionHandleMouseDown(event, edge)_
...
| --- | --- | --- |
| event | `Event` | The `mousedown` event. |
| edge | `'top'` <br/> `'bottom'` <br/> `'start'` <br/> `'end'` | The pressed handle's edge. |
...
::: ask-about-api afterRowCollapse|Hooks
...
_afterRowCollapse(currentCollapsedRows, destinationCollapsedRows, collapsePossible, successfullyCollapsed)_

Fired by the [NestedRows](@/api/nestedRows.md) plugin after parent rows are collapsed. This hook is fired when the
[Options#nestedRows](@/api/options.md#nestedrows) option is enabled.
...
| Param | Type | Description |
| --- | --- | --- |
| currentCollapsedRows | `Array` | A list of the physical indexes of the parent rows that were collapsed before the action. |
| destinationCollapsedRows | `Array` | A list of the physical indexes of the parent rows collapsed after the action. |
| collapsePossible | `boolean` | `true`, if every provided index points at a row that has children, `false` otherwise. |
| successfullyCollapsed | `boolean` | `true`, if the action changed the collapsed state, `false` otherwise. |



### afterRowExpand

::: ask-about-api afterRowExpand|Hooks
...
_afterRowExpand(currentCollapsedRows, destinationCollapsedRows, expandPossible, successfullyExpanded)_

Fired by the [NestedRows](@/api/nestedRows.md) plugin after parent rows are expanded. This hook is fired when the
[Options#nestedRows](@/api/options.md#nestedrows) option is enabled.
...
| currentCollapsedRows | `Array` | A list of the physical indexes of the parent rows that were collapsed before the action. |
| destinationCollapsedRows | `Array` | A list of the physical indexes of the parent rows collapsed after the action. |
| expandPossible | `boolean` | `true`, if every provided index points at a row that has children, `false` otherwise. |
| successfullyExpanded | `boolean` | `true`, if the action changed the collapsed state, `false` otherwise. |
...
The [Formulas](@/api/formulas.md) plugin creates a sheet on Handsontable's initialization (using the sheet name from
[Options#formulas](@/api/options.md#formulas), or a name auto-generated by HyperFormula, e.g. `Sheet1`, if none was provided), so
...
| row | `number` | Visual row index. |
| prop | `string` <br/> `number` | Property name or column index. For array-based data, this is the physical column                            index. When `columns[i].data` is a function, this is the visual column index. |
| [source] | `string` | `optional` String that identifies source of hook call                          ([list of all available sources](@/guides/getting-started/events-and-hooks/events-and-hooks.md#definition-for-source-argument)). |
...
| Param | Type | Description |
| --- | --- | --- |
| stateBefore | `object` | An object where each key is a visual row index and each value is an array                             of class names indexed by visual column. |
...
| Param | Type | Description |
| --- | --- | --- |
| changes | `Array<Array>` | 2D array containing information about each of the edited cells `[[row, prop, oldVal, newVal], ...]`.                          `row` is a visual row index. `prop` is a property name, a column index, or – when                          [`columns[].data`](@/api/options.md#columns) is a function – the column accessor function.                          To resolve a visual column index from `prop`, call [`propToCol()`](@/api/core.md#proptocol).                          Unlike [`beforeValidate`](@/api/hooks.md#beforevalidate) and                          [`afterValidate`](@/api/hooks.md#aftervalidate), this hook passes the accessor function                          as `prop` so the grid can write data back. Read more:                          [Binding to data: Identify changed columns in hooks](@/guides/getting-started/binding-to-data/binding-to-data.md#identify-changed-columns-in-hooks). |
| [source] | `string` | `optional` String that identifies source of hook call                          ([list of all available sources](@/guides/getting-started/events-and-hooks/events-and-hooks.md#definition-for-source-argument)). |
...
| Param | Type | Description |
| --- | --- | --- |
| index | `number` | Represents the visual index at which new row(s) are about to be inserted.                       Note that the actual visual index of the inserted row(s) may differ - use the                       `afterCreateRow` hook to get the final position. |
| amount | `number` | Number of rows to be created. |
| [source] | `string` | `optional` String that identifies source of hook call                          ([list of all available sources](@/guides/getting-started/events-and-hooks/events-and-hooks.md#definition-for-source-argument)). |
...
::: ask-about-api beforeMoveCells|Hooks
...
_beforeMoveCells(sourceRange, targetTopLeft, isCopy) ⇒ void | boolean_
...
| Param | Type | Description |
| --- | --- | --- |
| sourceRange | `CellRange` | The range being moved. |
| targetTopLeft | `CellCoords` | The top-left target cell. |
| isCopy | `boolean` | `true` when copying (Ctrl held) instead of moving. |
...
::: ask-about-api beforeRowCollapse|Hooks
...
_beforeRowCollapse(currentCollapsedRows, destinationCollapsedRows, collapsePossible) ⇒ undefined | boolean_

Fired by the [NestedRows](@/api/nestedRows.md) plugin before parent rows are collapsed. This hook is fired when the
[Options#nestedRows](@/api/options.md#nestedrows) option is enabled.
...
| Param | Type | Description |
| --- | --- | --- |
| currentCollapsedRows | `Array` | A list of the physical indexes of the currently collapsed parent rows. |
| destinationCollapsedRows | `Array` | A list of the physical indexes of the parent rows that will be collapsed. |
| collapsePossible | `boolean` | `true`, if every provided index points at a row that has children, `false` otherwise. |
...
::: ask-about-api beforeRowExpand|Hooks
...
_beforeRowExpand(currentCollapsedRows, destinationCollapsedRows, expandPossible) ⇒ undefined | boolean_

Fired by the [NestedRows](@/api/nestedRows.md) plugin before parent rows are expanded. This hook is fired when the
[Options#nestedRows](@/api/options.md#nestedrows) option is enabled.
...
| --- | --- | --- |
| currentCollapsedRows | `Array` | A list of the physical indexes of the currently collapsed parent rows. |
| destinationCollapsedRows | `Array` | A list of the physical indexes of the parent rows that will stay collapsed. |
| expandPossible | `boolean` | `true`, if every provided index points at a row that has children, `false` otherwise. |
...
_modifyCopyableRange(copyableRanges) ⇒ Array&lt;object&gt; | undefined_

Fired by [CopyPaste](@/api/copyPaste.md) plugin to allow modifying the range that is about to be copied or cut. It's
recalculated whenever the selection changes, and again right before the values are copied or cut to the
clipboard. This hook is fired when [Options#copyPaste](@/api/options.md#copypaste) option is enabled. It's also fired by the
[Autofill](@/api/autofill.md) plugin while a fill-handle drag is in progress, to determine the range that would be
...
| Param | Type | Description |
| --- | --- | --- |
| copyableRanges | `Array<object>` | An array of objects with ranges of the visual indexes (`startRow`, `startCol`,                                  `endRow`, `endCol`) that are copyable. |


**Returns**: `Array<object>` | `undefined` - The modified array of copyable ranges. If nothing is returned, the ranges
...
::: ask-about-api modifySinglePassLayout|Hooks
...
_modifySinglePassLayout(singlePassLayout) ⇒ boolean | void_
...
| Param | Type | Description |
| --- | --- | --- |
| singlePassLayout | `boolean` | `true` when single-pass rendering is currently enabled. |
