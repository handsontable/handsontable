...
const recipePages: RecipePage[] = [
  ...
  { path: 'recipes/data-management/server-side-django', framework: 'javascript-data-grid', hasExamples: true },
  { path: 'recipes/data-management/server-side-laravel', framework: 'javascript-data-grid', hasExamples: true },
  { path: 'recipes/data-management/server-side-nestjs', framework: 'javascript-data-grid', hasExamples: true },
