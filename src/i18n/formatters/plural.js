import {registerGlobal, registerSpecific} from '../formattersController';
...
function pluralize(phrases, settings) {
  ...
  if (Array.isArray(phrases) && isPluralDeterminantNumberLike) {
    return phrases[defaultPluralizationFunction(pluralDeterminant)];
  }

  return phrases;
};

registerGlobal(pluralize);
// registerSpecific(['pl'], pluralize);
