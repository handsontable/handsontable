...
export const JsFiddleButton = (props) => {
  ...
  return (
    ...
    >
      ...
      <textarea name="js" readOnly value={decode(code)} />
      <textarea name="html" readOnly value={getHtml(hotId)} />
      <textarea name="css" readOnly value={getCss(useActiveVersion().name)} />
    </form>
  );
};

JsFiddleButton.propTypes = {
