/* eslint-disable */ // File swizzled from a docusaurus theme
/**
        ...
        <div
          ...
          <div className={styles.docItemContainer}>
            ...
            {(editUrl || lastUpdatedAt || lastUpdatedBy) && (
              <div className={`margin-vert--l ${styles.docSeparator}`}>
                <div className="row">
                  <div className="col">
                    {editUrl && (
                      <a
                        ...
                        className={styles.docSuggestEdits}>
                        <svg
                          fill="currentColor"
                          height="14px"
                          width="14px"
                  ...
                  {(lastUpdatedAt || lastUpdatedBy) && (
                    <div className="col text--right">
                      <span className={styles.docLastUpdatedAt}>
                          Last updated{' '}
                          {lastUpdatedAt && (
                            <>
                              on{' '}
