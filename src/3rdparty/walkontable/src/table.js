  ...
  alignOverlaysWithTrimmingContainer() {
    ...
    if (!this.isWorkingOnClone()) {
      ...
      if (trimmingElement === this.wot.rootWindow) {
        ...
        this.holder.style.width = getStyle(trimmingElement, 'width', this.wot.rootWindow);
        this.holder.style.height = getStyle(trimmingElement, 'height', this.wot.rootWindow);
