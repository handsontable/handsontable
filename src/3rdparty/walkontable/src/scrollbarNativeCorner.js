...
WalkontableCornerScrollbarNative.prototype.resetFixedPosition = function () {
  ...
  elem.style.width = Handsontable.Dom.outerWidth(this.clone.wtTable.TABLE) + 1 + 'px';
  elem.style.height = Handsontable.Dom.outerHeight(this.clone.wtTable.TABLE) + 1 + 'px';
};
