describe('manualRowMove', () => {
  ...
  describe('UI', () => {
    ...
    describe('selection', () => {
      it('should show properly when moving multiple rows from the top to the bottom', () => {
        handsontable({
          data: Handsontable.helper.createSpreadsheetData(10, 10),
          rowHeaders: true,
          manualRowMove: true
      ...
      it('should show properly when moving multiple rows from the bottom to the top', () => {
        handsontable({
          data: Handsontable.helper.createSpreadsheetData(10, 10),
          rowHeaders: true,
          manualRowMove: true
