describe('ColumnSorting', () => {
  ...
  describe('sorting is passive by default', () => {
    describe('should clear sort state and leave new data untouched (not sort again)', () => {
      ...
      // DIFF - MultiColumnSorting & ColumnSorting: removed test named: "after trimming row".
      // DIFF - MultiColumnSorting & ColumnSorting: removed test named: "after untrimming row".
