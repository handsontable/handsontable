 ...
 * among [other features](https://docs.handsontable.com/demo-context-menu.html).
 * Possible values:
 ...
 *
 * See [the dropdown menu demo](https://docs.handsontable.com/demo-dropdown-menu.html) for examples.
 *
 * @example
 * ```
