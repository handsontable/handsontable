...
class ManualColumnResize extends BasePlugin {
  ...
  enablePlugin() {
    ...
    this.hot.columnIndexMapper.registerIndexedElement(COLUMN_WIDTHS_MAP_NAME, this.columnWidthsMap);
  ...
  disablePlugin() {
    ...
    this.hot.columnIndexMapper.unregisterIndexedElement(COLUMN_WIDTHS_MAP_NAME);
    super.disablePlugin();
  }
