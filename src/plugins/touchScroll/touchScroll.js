...
class TouchScroll extends BasePlugin {
  ...
  init() {
    ...
    this.scrollbars = [
      ...
      this.hot.view.wt.wtOverlays.topLeftCornerOverlay
    ];

    this.clones = [
      this.hot.view.wt.wtOverlays.topOverlay.clone.wtTable.holder.parentNode,
      this.hot.view.wt.wtOverlays.leftOverlay.clone.wtTable.holder.parentNode,
      this.hot.view.wt.wtOverlays.topLeftCornerOverlay.clone.wtTable.holder.parentNode
    ];
  }
