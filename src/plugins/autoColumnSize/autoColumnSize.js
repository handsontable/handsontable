...
class AutoColumnSize extends BasePlugin {
  ...
  constructor(hotInstance) {
    ...
    this.hot.columnIndexMapper.registerIndexedElement(COLUMN_SIZE_MAP_NAME, this.columnWidthsMap);
  }
   ...
   */
  destroy() {
    this.hot.columnIndexMapper.unregisterIndexedElement(COLUMN_SIZE_MAP_NAME);
    this.ghostTable.clean();
    super.destroy();
  }
}
