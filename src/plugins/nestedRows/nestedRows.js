...
class NestedRows extends BasePlugin {
  ...
  enablePlugin() {
    ...
    this.collapsedRowsMap = this.hot.rowIndexMapper.registerIndexedElement('nestedRows', new TrimmingMap());
   ...
   */
  disablePlugin() {
    this.hot.rowIndexMapper.unregisterIndexedElement('nestedRows');
