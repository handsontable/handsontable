...
import {
  operationResult as disjunctionWithExtraCondition
} from 'handsontable/plugins/filters/logicalOperations/disjunctionWithExtraCondition';
...
describe('Operation on set of conditions (`disjunction and variable`)', () => {
  ...
  it('should filter matching values', () => {
    expect(disjunctionWithExtraCondition([
      trueConditionMock(),
      trueConditionMock(),
      trueConditionMock()
