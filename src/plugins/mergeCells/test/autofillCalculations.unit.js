...
describe('MergeCells-Autofill calculations', () => {
  describe('correctSelectionAreaSize', () => {
    it('Should correct the provided selection area, so it\'s not selecting only a part of a collection', () => {
      ...
      expect(JSON.stringify(area)).toEqual(JSON.stringify([0, 0, 2, 2]));
    });
  });
  ...
  describe('snapDragArea', () => {
    it('Should snap the drag area to the farthest collection, so it won\'t clip any of the cell collections.', () => {
      ...
      let foundCollections = [new Collection(5, 4, 2, 2)];
  ...
  describe('getFarthestCollection', () => {
    it('Should get the to-be-farthest collection in the newly filled area.', () => {
      const instance = new AutofillCalculations({});

      let baseArea = [3, 3, 10, 11];
      let dragArea = [3, 3, 13, 11];
      let direction = 'down';
      let collectionArray = [new Collection(5, 4, 2, 2), new Collection(8, 8, 2, 3)];

      expect(instance.getFarthestCollection(baseArea, dragArea, direction, collectionArray)).toEqual(collectionArray[0]);

      dragArea = [3, 3, 16, 11];
      expect(instance.getFarthestCollection(baseArea, dragArea, direction, collectionArray)).toEqual(collectionArray[1]);
  ...
  describe('isFarther', () => {
    it('Should check if the second provided collection is "farther" in the provided direction.', () => {
      const instance = new AutofillCalculations({});
      const first = new Collection(5, 4, 2, 2);
  ...
  describe('recreateAfterDataPopulation', () => {
    it('Should recreate the collections after the autofill process.', () => {
      const hotMock = {
        render: () => {
        },
        countCols: () => 100,
      ...
      const instance = new AutofillCalculations({
        collectionContainer: new CollectionContainer(hotMock),
        hot: hotMock
      });

      const changes = JSON.parse('[[10,3,"[10, 3]","[5, 3]"],[10,4,"[10, 4]","[5, 4]"],[10,5,"[10, 5]",null],[10,6,"[10,' +
        ' 6]","[5, 6]"],[10,7,"[10, 7]","[5, 7]"],[10,8,"[10, 8]","[5, 8]"],[10,9,"[10, 9]","[5, 9]"],[10,10,"[10, 10]",' +
        '"[5, 10]"],[10,11,"[10, 11]","[5, 11]"],[11,3,"[11, 3]","[6, 3]"],[11,4,"[11, 4]",null],[11,5,"[11, 5]",null],[' +
        '11,6,"[11, 6]","[6, 6]"],[11,7,"[11, 7]","[6, 7]"],[11,8,"[11, 8]","[6, 8]"],[11,9,"[11, 9]","[6, 9]"],[11,10,"' +
        '[11, 10]","[6, 10]"],[11,11,"[11, 11]","[6, 11]"],[12,3,"[12, 3]","[7, 3]"],[12,4,"[12, 4]","[7, 4]"],[12,5,"[1' +
        '2, 5]","[7, 5]"],[12,6,"[12, 6]","[7, 6]"],[12,7,"[12, 7]","[7, 7]"],[12,8,"[12, 8]","[7, 8]"],[12,9,"[12, 9]",' +
        '"[7, 9]"],[12,10,"[12, 10]","[7, 10]"],[12,11,"[12, 11]","[7, 11]"],[13,3,"[13, 3]","[8, 3]"],[13,4,"[13, 4]","' +
        '[8, 4]"],[13,5,"[13, 5]","[8, 5]"],[13,6,"[13, 6]","[8, 6]"],[13,7,"[13, 7]","[8, 7]"],[13,8,"[13, 8]","[8, 8]"' +
        '],[13,9,"[13, 9]",null],[13,10,"[13, 10]",null],[13,11,"[13, 11]","[8, 11]"],[14,3,"[14, 3]","[9, 3]"],[14,4,"[' +
        '14, 4]","[9, 4]"],[14,5,"[14, 5]","[9, 5]"],[14,6,"[14, 6]","[9, 6]"],[14,7,"[14, 7]","[9, 7]"],[14,8,"[14, 8]"' +
        ',null],[14,9,"[14, 9]",null],[14,10,"[14, 10]",null],[14,11,"[14, 11]","[9, 11]"],[15,3,"[15, 3]","[5, 3]"],[15' +
        ',4,"[15, 4]","[5, 4]"],[15,5,"[15, 5]",null],[15,6,"[15, 6]","[5, 6]"],[15,7,"[15, 7]","[5, 7]"],[15,8,"[15, 8]' +
        '","[5, 8]"],[15,9,"[15, 9]","[5, 9]"],[15,10,"[15, 10]","[5, 10]"],[15,11,"[15, 11]","[5, 11]"],[16,3,"[16, 3]"' +
        ',"[6, 3]"],[16,4,"[16, 4]",null],[16,5,"[16, 5]",null],[16,6,"[16, 6]","[6, 6]"],[16,7,"[16, 7]","[6, 7]"],[16,' +
        '8,"[16, 8]","[6, 8]"],[16,9,"[16, 9]","[6, 9]"],[16,10,"[16, 10]","[6, 10]"],[16,11,"[16, 11]","[6, 11]"]]');

      instance.currentFillData = {
        dragDirection: 'down',
        foundCollections: [new Collection(5, 4, 2, 2), new Collection(8, 8, 2, 3)],
        cycleLength: 5
      };

      instance.recreateAfterDataPopulation(changes);
      expect(instance.collectionContainer.collections.length).toEqual(3);
      expect(JSON.stringify(instance.collectionContainer.collections[0])).toEqual(JSON.stringify({
        row: 5 + 5,
        col: 4,
        rowspan: 2,
        colspan: 2,
      ...
      expect(JSON.stringify(instance.collectionContainer.collections[1])).toEqual(JSON.stringify({
        row: 8 + 5,
        col: 8,
        rowspan: 2,
        colspan: 3,
      ...
      expect(JSON.stringify(instance.collectionContainer.collections[2])).toEqual(JSON.stringify({
        row: 5 + 10,
        col: 4,
        rowspan: 2,
        colspan: 2,
