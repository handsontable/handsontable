...
export function init() {
  ...
  // Pre-select an interior range so the move zone bands are immediately
  // visible and the drag can be initiated without an extra click.
  hot.selectCells([[2, 2, 4, 4]]);
