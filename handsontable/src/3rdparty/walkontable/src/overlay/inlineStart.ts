...
export class InlineStartOverlay extends Overlay {
  ...
  setScrollPosition(pos: number) {
    ...
    } else if (pos !== (scrollableElement as HTMLElement).scrollLeft) {
      const oldScrollLeft = (scrollableElement as HTMLElement).scrollLeft;

      (scrollableElement as HTMLElement).scrollLeft = pos;
      result = oldScrollLeft !== (scrollableElement as HTMLElement).scrollLeft;
    }
