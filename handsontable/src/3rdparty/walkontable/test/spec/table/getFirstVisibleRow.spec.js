describe('WalkontableTable', () => {
  ...
  describe('getFirstVisibleRow()', () => {
    ...
    it('should return -1 error code if there are rendered rows and columns after fixed overlays are disabled', async() => {
      ...
      expectWtTable(wt, wtTable => wtTable.getFirstVisibleRow(), 'master').toBe(0);
    ...
    it('should return source index only for fully visible row (the first row is fully visible)', async() => {
      createDataArray(18, 18);
    ...
    it('should return source index only for fully visible row (the first row is partially visible)', async() => {
      createDataArray(18, 18);
