describe('WalkontableTable', () => {
  ...
  describe('getLastPartiallyVisibleColumn()', () => {
    ...
    it('should return -1 error code if there are rendered rows and columns after fixed overlays are disabled', async() => {
      ...
      expectWtTable(wt, wtTable => wtTable.getLastPartiallyVisibleColumn(), 'master').toBe(3);
    ...
    it('should return the same column index as for fully visible column when the column is aligned to the right edge of the table', async() => {
      createDataArray(18, 18);
