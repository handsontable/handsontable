describe('renderAllRows option', () => {
  ...
  it('should render all rows once without rerendering after fast render', async() => {
    ...
    expect(cellRenderer).toHaveBeenCalledTimes(900); // 100 rows * 9 virtualized columns
    ...
    expect(cellRenderer).toHaveBeenCalledTimes(1800);
  });
});
