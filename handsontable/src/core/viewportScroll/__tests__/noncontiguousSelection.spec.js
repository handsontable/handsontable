describe('Non-contiguous selection scroll', () => {
  ...
  describe('for partially visible cell on the right table\'s edge', () => {
    ...
    xit('should scroll the viewport after using API (selecting fully visible column to partially visible column)', async() => {
      handsontable({
        data: createSpreadsheetData(5, 10),
        width: 300,
        height: 300,
    ...
    xit('should not scroll the viewport after using API (selecting partially visible column to fully visible column)', async() => {
      handsontable({
        data: createSpreadsheetData(5, 10),
        width: 300,
        height: 300,
  ...
  //   fit('should scroll the viewport after mouse click', async() => {
  //     handsontable({
  //       data: createSpreadsheetData(5, 10),
  //       width: 300,
  //       height: 300,
