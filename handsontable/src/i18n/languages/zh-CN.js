...
const dictionary = {
  ...
  [C.CONTEXTMENU_ITEMS_EXPORT]: '导出',
  [C.CONTEXTMENU_ITEMS_EXPORT_FILE_CSV]: '为 CSV',
  [C.CONTEXTMENU_ITEMS_EXPORT_FILE_XLSX]: '为 Excel',
  [C.EXPORT_FILE_DIALOG_TITLE]: '正在导出…',
  ...
  [C.EMPTY_DATA_STATE_TITLE_LOADING]: '正在加载数据',
  [C.EMPTY_DATA_STATE_DESCRIPTION_LOADING]: '请稍候。',

  [C.DATA_PROVIDER_ERRORS_FETCH]: '无法加载数据',
  [C.DATA_PROVIDER_ERRORS_CREATE]: '无法创建行',
