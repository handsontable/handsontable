...
const dictionary = {
  ...
  [C.CONTEXTMENU_ITEMS_EXPORT]: '匯出',
  [C.CONTEXTMENU_ITEMS_EXPORT_FILE_CSV]: '為 CSV',
  [C.CONTEXTMENU_ITEMS_EXPORT_FILE_XLSX]: '為 Excel',
  [C.EXPORT_FILE_DIALOG_TITLE]: '正在匯出…',
  ...
  [C.DATA_PROVIDER_ERRORS_FETCH]: '無法載入資料',
  [C.DATA_PROVIDER_ERRORS_CREATE]: '無法建立列',
