...
const dictionary = {
  ...
  [C.CONTEXTMENU_ITEMS_EXPORT]: 'Exportovat',
  [C.CONTEXTMENU_ITEMS_EXPORT_FILE_CSV]: 'Do CSV',
  [C.CONTEXTMENU_ITEMS_EXPORT_FILE_XLSX]: 'Do Excelu',
  ...
  [C.FILTERS_CONDITIONS_AFTER_OR_EQUAL]: 'Po nebo rovno',
  [C.FILTERS_CONDITIONS_BEFORE]: 'Před',
  [C.FILTERS_CONDITIONS_BEFORE_OR_EQUAL]: 'Před nebo rovno',
