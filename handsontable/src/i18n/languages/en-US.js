...
const dictionary = {
  ...
  [C.CONTEXTMENU_ITEMS_COPY_WITH_COLUMN_HEADERS]: 'Copy with headers',
  [C.CONTEXTMENU_ITEMS_COPY_WITH_COLUMN_GROUP_HEADERS]: 'Copy with group headers',
  [C.CONTEXTMENU_ITEMS_COPY_COLUMN_HEADERS_ONLY]: 'Copy headers only',
