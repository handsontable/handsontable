...
const dictionary = {
  ...
  [C.CONTEXTMENU_ITEMS_EXPORT]: 'خروجی',
  [C.CONTEXTMENU_ITEMS_EXPORT_FILE_CSV]: 'به CSV',
  [C.CONTEXTMENU_ITEMS_EXPORT_FILE_XLSX]: 'به Excel',
  ...
  [C.FILTERS_CONDITIONS_AFTER_OR_EQUAL]: 'بعد یا مساوی',
  [C.FILTERS_CONDITIONS_BEFORE]: 'قبل',
  [C.FILTERS_CONDITIONS_BEFORE_OR_EQUAL]: 'قبل یا مساوی',
