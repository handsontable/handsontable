export default {
  ...
  "icon-size": "sizing.size-4",
  "table-transition": "0.2s",
  "border-color": {
  ...
  "shadow-x": "sizing.size-0",
  "shadow-y": "sizing.size-2",
  "shadow-blur": "sizing.size-4",
  "shadow-opacity": "6%",
  ...
  "cell-horizontal-border-color": "colors.transparent",
  ...
  "cell-editor-shadow-blur-radius": "8px",
  "cell-editor-shadow-color": "themes.accent-color",
  "cell-success-background-color": "#37bc6c4d",
  "cell-error-background-color": "#fa4d324d",
  "cell-read-only-background-color": "themes.background-secondary-color",
  ...
  "cell-autofill-border-radius": "sizing.size-1",
  ...
  "move-backlight-opacity": "6%",
  "move-indicator-color": "themes.accent-color",
  ...
  "header-highlighted-shadow-size": "1px",
  ...
  "header-active-foreground-color": "themes.background-color",
  ...
  "checkbox-checked-disabled-icon-color": "themes.disabled-color",
  ...
  "checkbox-indeterminate-disabled-icon-color": "themes.disabled-color",
  ...
  "radio-disabled-background-color": "themes.background-secondary-color",
  ...
  "radio-checked-disabled-background-color": "themes.background-secondary-color",
  "radio-checked-disabled-icon-color": "themes.disabled-color",
  "icon-button-border-radius": "sizing.size-4",
  "icon-button-large-border-radius": "sizing.size-1",
  ...
  "icon-button-hover-icon-color": "themes.foreground-color",
  "icon-button-active-border-color": "colors.transparent",
  "icon-button-active-background-color": "colors.transparent",
  "icon-button-active-icon-color": "themes.background-color",
  "icon-button-active-hover-border-color": "colors.transparent",
  "icon-button-active-hover-background-color": {
    "light": "colors.palette.950",
    "dark": "colors.primary.200"
  },
  "icon-button-active-hover-icon-color": "themes.background-color",
  "collapse-button-border-radius": "sizing.size-4",
  "collapse-button-open-border-color": "colors.transparent",
  "collapse-button-open-background-color": "colors.transparent",
  ...
  "collapse-button-open-hover-border-color": "colors.transparent",
  "collapse-button-open-hover-background-color": "colors.transparent",
  ...
  "collapse-button-close-border-color": "colors.transparent",
  "collapse-button-close-background-color": "colors.transparent",
  ...
  "collapse-button-close-hover-border-color": "colors.transparent",
  "collapse-button-close-hover-background-color": "colors.transparent",
  ...
  "button-border-radius": "sizing.size-4",
  ...
  "comments-textarea-border-color": "colors.transparent",
  ...
  "link-color": "themes.accent-color",
  "link-hover-color": {
    "light": "colors.primary.600",
    "dark": "colors.primary.100"
  },
  ...
  "menu-shadow-opacity": "6%",
  "menu-item-hover-color": "themes.accent-color",
  "menu-item-hover-color-opacity": "8%",
  "menu-item-active-color": "themes.accent-color",
  "menu-item-active-color-opacity": "12%",
  ...
  "dialog-content-border-radius": "sizing.size-4",
  "dialog-content-background-color": "themes.background-color",
