export default {
  ...
  "wrapper-border-radius": "sizing.size-1",
  ...
  "header-active-foreground-color": "colors.white",
  "header-active-background-color": "themes.accent-color",
  ...
  "header-row-active-background-color": "themes.accent-color",
  "checkbox-size": "themes.icon-size",
  "checkbox-border-radius": "sizing.size-1",
  ...
  "checkbox-indeterminate-icon-color": "colors.white",
  ...
  "checkbox-indeterminate-focus-icon-color": "colors.white",
  ...
  "radio-border-color": "themes.border-color",
  "radio-background-color": "themes.background-color",
  "radio-icon-color": "colors.transparent",
  "radio-focus-border-color": "themes.border-color",
  ...
  "icon-button-active-background-color": "themes.accent-color",
  "icon-button-active-icon-color": "colors.white",
  ...
  "icon-button-active-hover-icon-color": "colors.white",
  "collapse-button-border-radius": "sizing.size-1",
  ...
  "button-border-radius": "sizing.size-1",
  ...
  "primary-button-foreground-color": "colors.white",
  ...
  "link-hover-color": "themes.accent-color",
  ...
  "menu-border-radius": "sizing.size-1",
