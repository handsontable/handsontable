export default {
  ...
  line_height: "20px",
  line_height_small: "18px",
  font_weight: "400",
  letter_spacing: "0px",
  gap_size: "density.gap",
  icon_size: "sizing.size_4",
  table_transition: "0.15s",
  border_color: {
  ...
  shadow_x: "sizing.size_0",
  shadow_y: "sizing.size_2",
  shadow_blur: "sizing.size_4",
  shadow_opacity: "8%",
  ...
  wrapper_border_radius: "sizing.size_1",
  ...
  cell_read_only_background_color: "themes.background_secondary_color",
  ...
  cell_autofill_border_radius: "sizing.size_1",
  ...
  move_backlight_opacity: "8%",
  move_indicator_color: "themes.accent_color",
  ...
  header_active_foreground_color: "colors.white",
  header_active_background_color: "themes.accent_color",
  ...
  header_row_active_foreground_color: "themes.background_color",
  header_row_active_background_color: "themes.accent_color",
  checkbox_size: "themes.icon_size",
  checkbox_border_radius: "sizing.size_1",
  ...
  checkbox_checked_disabled_icon_color: "themes.disabled_color",
  checkbox_indeterminate_border_color: {
    light: "colors.primary.400",
    dark: "colors.primary.200"
  },
  checkbox_indeterminate_background_color: "themes.accent_color",
  checkbox_indeterminate_icon_color: "colors.white",
  ...
  checkbox_indeterminate_focus_icon_color: "colors.white",
  ...
  checkbox_indeterminate_disabled_icon_color: "themes.disabled_color",
  radio_size: "themes.icon_size",
  radio_border_color: "themes.border_color",
  radio_background_color: "themes.background_color",
  radio_icon_color: "colors.transparent",
  radio_focus_border_color: "themes.border_color",
  ...
  radio_checked_disabled_icon_color: "themes.disabled_color",
  icon_button_border_radius: "sizing.size_0_5",
  icon_button_large_border_radius: "sizing.size_1",
  ...
  icon_button_active_background_color: "themes.accent_color",
  icon_button_active_icon_color: "colors.white",
  ...
  icon_button_active_hover_icon_color: "colors.white",
  collapse_button_border_radius: "sizing.size_1",
  ...
  button_border_radius: "sizing.size_1",
  ...
  primary_button_foreground_color: "colors.white",
  ...
  comments_textarea_border_color: "colors.transparent",
  ...
  link_hover_color: "themes.accent_color",
  ...
  input_hover_background_color: "themes.background_color",
  ...
  input_focus_background_color: "themes.background_color",
  menu_border_width: "1px",
  menu_border_radius: "sizing.size_1",
  ...
  menu_shadow_color: "themes.shadow_color",
  menu_shadow_opacity: "8%",
