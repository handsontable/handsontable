/*
 * Starlight theme tokens -- blends classic's compact typography (13px/21px line height)
 * with main's modern styling (rounded corners, transitions, softer shadows).
 * Paired with comfortable density this creates a unique layout: tall rows (21px line
 * height + comfortable padding) with a classic typographic feel.
 */
...
export default {
  ...
  shadowY: 'sizing.size_1',
  shadowBlur: 'sizing.size_3',
  shadowOpacity: '10%',
