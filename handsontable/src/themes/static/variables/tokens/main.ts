...
const mainTokens: ThemeTokensConfig = {
  ...
  cellSelectionHandleLength: 'sizing.size_4',
  ...
  iconButtonHoverIconColor: ['colors.palette.400', 'colors.palette.300'],
  ...
  sheetsBarTabActiveBackgroundColor: ['colors.palette.100', 'colors.palette.700'],
