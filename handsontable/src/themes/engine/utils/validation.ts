...
const VALID_TOKEN_KEYS = new Set([
  ...
  'formulaReferenceColor1',
  'formulaReferenceColor2',
  'formulaReferenceColor3',
  'formulaReferenceColor4',
  'formulaReferenceColor5',
  'formulaReferenceColor6',
  'formulaReferenceColor7',
  'formulaReferenceColor8',
  'formulaReferenceColor9',
  'formulaReferenceColor10',
  // Cell states
