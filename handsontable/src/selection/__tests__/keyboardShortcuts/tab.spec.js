describe('Selection navigation', () => {
  ...
  describe('"Tab"', () => {
    it('should move the selection right for single cell selection', async() => {
      handsontable({
        rowHeaders: true,
        colHeaders: true,
        startRows: 5,
    ...
    it('should move the selection right within a multiple selected cells only', async() => {
      handsontable({
        rowHeaders: true,
        colHeaders: true,
        startRows: 5,
    ...
    it('should move the selection right within a non-contiguous selection and jump to the next layers (selected multiple cells)', async() => {
      handsontable({
        rowHeaders: true,
        colHeaders: true,
        startRows: 5,
    ...
    it('should move the selection right within a non-contiguous selection and jump to the next layers (selected multiple single cells)', async() => {
      handsontable({
        rowHeaders: true,
        colHeaders: true,
        startRows: 5,
    ...
    it('should move the selection right within a column header selection', async() => {
      handsontable({
        rowHeaders: true,
        colHeaders: true,
        startRows: 2,
    ...
    it('should move the selection right within a row header selection', async() => {
      handsontable({
        rowHeaders: true,
        colHeaders: true,
        startRows: 5,
    ...
    it('should move the selection right ignoring hidden indexes', async() => {
      handsontable({
    ...
    it('should move the selection right when there is no columns (navigableHeaders on)', async() => {
      handsontable({
        data: [[], [], [], [], []],
        rowHeaders: true,
        navigableHeaders: true,
    ...
    it('should move the selection right when all columns are hidden (navigableHeaders on)', async() => {
      handsontable({
        data: createSpreadsheetData(5, 5),
        rowHeaders: true,
        navigableHeaders: true,
    ...
    it('should move the selection right when there is no rows (navigableHeaders on)', async() => {
      handsontable({
        data: [],
        columns: [{}, {}, {}, {}, {}],
        colHeaders: true,
    ...
    it('should move the selection right when all rows are hidden (navigableHeaders on)', async() => {
      handsontable({
        data: createSpreadsheetData(5, 5),
        colHeaders: true,
        navigableHeaders: true,
