describe('Selection navigation', () => {
  ...
  describe('"Enter"', () => {
    it('should move the selection down for single cell selection', () => {
      handsontable({
        rowHeaders: true,
        colHeaders: true,
        startRows: 5,
      ...
      selectCell(2, 2);
      keyDownUp('enter'); // opens editor
      keyDownUp('enter'); // navigates down
    ...
    it('should move the selection down within a multiple selected cells only', () => {
      handsontable({
        rowHeaders: true,
        colHeaders: true,
        startRows: 5,
    ...
    it('should move the selection down within a non-contiguous selection only for the last layer', () => {
      handsontable({
        rowHeaders: true,
        colHeaders: true,
        startRows: 5,
    ...
    it('should move the selection down within a column header selection', () => {
      handsontable({
        rowHeaders: true,
        colHeaders: true,
        startRows: 2,
    ...
    it('should move the selection down within a row header selection', () => {
      handsontable({
        rowHeaders: true,
        colHeaders: true,
        startRows: 5,
      ...
      expect(getSelectedRange()).toEqualCellRange(['highlight: 2,-2 from: 2,-2 to: 3,1']);
      expect(`
        |   :   ║ - : - |
        |===:===:===:===|
        |   :   ║   :   |
    ...
    it('should move the selection down ignoring hidden indexes', () => {
      handsontable({
    ...
    it('should move the selection down when there is no columns (navigableHeaders on)', () => {
      handsontable({
        data: [[], [], [], [], []],
        rowHeaders: true,
        navigableHeaders: true,
    ...
    it('should move the selection down when all columns are hidden (navigableHeaders on)', () => {
      handsontable({
        data: createSpreadsheetData(5, 5),
        rowHeaders: true,
        navigableHeaders: true,
    ...
    it('should move the selection down when there is no rows (navigableHeaders on)', () => {
      handsontable({
        data: [],
        columns: [{}, {}, {}, {}, {}],
        colHeaders: true,
    ...
    it('should move the selection down when all rows are hidden (navigableHeaders on)', () => {
      handsontable({
        data: createSpreadsheetData(5, 5),
        colHeaders: true,
        navigableHeaders: true,
