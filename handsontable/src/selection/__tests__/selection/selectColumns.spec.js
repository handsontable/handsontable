describe('Selection', () => {
  ...
  describe('`selectColumns` method', () => {
    ...
    it('should not be possible to move the focus selection to header (navigableHeaders off, with headers)', () => {
      handsontable({
      ...
      expect(hot().selection.selectColumns(2, 3, -1)).toBe(false);
      expect(`
        |   :   :   ║   :   :   :   |
        |   :   :   ║   :   :   :   |
        |   :   :   ║   :   :   :   |
      ...
      expect(hot().selection.selectColumns(2, 3, -3)).toBe(false);
      expect(`
        |   :   :   ║   :   :   :   |
        |   :   :   ║   :   :   :   |
        |   :   :   ║   :   :   :   |
    ...
    it('should not highlight headers as selected when there are no rows (navigableHeaders on)', () => {
      handsontable({
        data: [],
        navigableHeaders: true,
        colHeaders: true,
