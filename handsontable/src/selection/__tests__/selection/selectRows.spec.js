  ...
  describe('`selectRows` method', () => {
    ...
    it('should highlight single row (default selectionMode, multiple headers)', () => {
      ...
      expect(`
        ...
        |   :   :   ║   :   :   :   :   :   |
        `).toBeMatchToSelectionPattern();
      expect(getSelectedRange()).toEqualCellRange(['highlight: 2,0 from: 2,-3 to: 2,5']);
    });
    ...
    it('should highlight non-contiguous selection when CTRL key is pressed (multiple headers, navigableHeaders on)', () => {
      ...
      expect(`
        ...
        `).toBeMatchToSelectionPattern();
      expect(getSelectedRange()).toEqualCellRange([
        'highlight: 2,0 from: 2,-3 to: 2,5',
        'highlight: 0,0 from: 0,-3 to: 0,5',
      ]);
    });
    ...
    it('should highlight range of the rows (default selectionMode, multiple headers, navigableHeaders on)', () => {
      ...
      expect(`
        ...
        | * : * : * ║ 0 : 0 : 0 : 0 : 0 : 0 |
        `).toBeMatchToSelectionPattern();
      expect(getSelectedRange()).toEqualCellRange(['highlight: 2,0 from: 2,-3 to: 3,5']);
    });
    ...
    it('should highlight range of the rows (default selectionMode, reversed selection, multiple headers, navigableHeaders on)', () => {
      ...
      expect(`
        ...
        | * : * : * ║ A : 0 : 0 : 0 : 0 : 0 |
        `).toBeMatchToSelectionPattern();
      expect(getSelectedRange()).toEqualCellRange(['highlight: 3,0 from: 3,-3 to: 2,5']);
    });
    ...
    it('should be possible to move the focus selection to header (navigableHeaders on, with headers)', () => {
      ...
      expect(`
        ...
        | * : * : * ║ 0 : 0 : 0 |
        `).toBeMatchToSelectionPattern();
      expect(getSelectedRange()).toEqualCellRange(['highlight: 2,-1 from: 2,-3 to: 3,2']);
    ...
    it('should not highlight headers as selected when there are no columns (navigableHeaders on)', () => {
      handsontable({
        data: [[], []],
        navigableHeaders: true,
        rowHeaders: true,
