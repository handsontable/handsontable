...
export default function Core(
  ...
  this.updateSettings = function(settings: Partial<GridSettings>, init = false) {
     ...
     * that it survives the clear instead of being discarded (see GitHub issue #4446). Failed
     * validation results need a snapshot of their own (see GitHub issue #7553).
     */
