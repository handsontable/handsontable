...
export default function Core(rootElement, userSettings, rootInstanceSymbol = false) {
   ...
   *  | `'insert_col_start'` | Depending on your [`layoutDirection`](@/api/options.md#layoutdirection), insert a column to the left (in LTR) or to the right (in RTL) of a specified column. |
   *  | `'insert_col_end'`   | Depending on your [`layoutDirection`](@/api/options.md#layoutdirection), insert a column to the right (in LTR) or to the left (in RTL) of a specified column. |
