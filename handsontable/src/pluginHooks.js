...
const REGISTERED_HOOKS = [
   ...
   * @since 12.1.0
   * @param {number} column The visual column index of the column that is going to get frozen.
   ...
   * @since 12.1.0
   * @param {number} column The visual column index of the unfrozen column.
