  ...
  refreshPositions() {
    ...
    if (this.hot.isRtl()) {
      ...
      mouseOffsetStart = this.#target.eventPageX -
        (this.#rootElementOffset - (!(scrollableElement instanceof Window) ? scrollStart : 0));
    }
    ...
    } else if (scrollableElement instanceof Window && this.#hoveredColumn < this.#fixedColumnsStart) {
