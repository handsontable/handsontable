describe('CustomBorders', () => {
  ...
  describe('cooperation with the `HiddenRows` plugin', () => {
    it('should display custom borders (drawing range) properly when some rows are hidden ' +
      '(range starts from hidden row)', async() => {
      handsontable({
    ...
    it('should display custom borders (drawing range) properly when hiding rows that have been visible ' +
      '(hiding row at the start of the range)', async() => {
      handsontable({
        data: createSpreadsheetData(5, 5),
        rowHeaders: true,
        colHeaders: true,
    ...
    it('should display custom borders (drawing range) properly when some rows are hidden ' +
      '(range ends at hidden row)', async() => {
      handsontable({
        data: createSpreadsheetData(5, 5),
        rowHeaders: true,
        colHeaders: true,
    ...
    it('should display custom borders (drawing range) properly when hiding rows that have been visible ' +
      '(hiding row at the end of the range)', async() => {
      handsontable({
        data: createSpreadsheetData(5, 5),
        rowHeaders: true,
        colHeaders: true,
    ...
    it('should display custom borders (drawing range) properly when some rows are hidden ' +
      '(hidden row in the middle of the range)', async() => {
      handsontable({
        data: createSpreadsheetData(5, 5),
        rowHeaders: true,
        colHeaders: true,
    ...
    it('should display custom borders (drawing range) properly when hiding rows that have been visible ' +
      '(hiding row in the middle of the range)', async() => {
      handsontable({
        data: createSpreadsheetData(5, 5),
        rowHeaders: true,
        colHeaders: true,
    ...
    it('should not display custom border for single cell when it is placed on the hidden row', async() => {
      handsontable({
        data: createSpreadsheetData(5, 5),
        rowHeaders: true,
        colHeaders: true,
    ...
    it('should display custom borders for single cells properly when one of them is placed on the hidden row', async() => {
      handsontable({
        data: createSpreadsheetData(5, 5),
        rowHeaders: true,
        colHeaders: true,
    ...
    it('should not display custom border for single cell when row containing border is hidden by API call', async() => {
      handsontable({
        data: createSpreadsheetData(5, 5),
        rowHeaders: true,
        colHeaders: true,
    ...
    it('should display custom border for single cell when hidden row containing border has been shown by API call', async() => {
      handsontable({
        data: createSpreadsheetData(5, 5),
        rowHeaders: true,
        colHeaders: true,
