...
export class FiltersAction extends BaseAction {
  ...
  constructor({ conditionsStack, previousConditionsStack }: { conditionsStack: unknown, previousConditionsStack: unknown }) {
    super('filter');
  ...
  undo(hot: HotInstance, undoneCallback: HookCallback) {
    ...
    filters.importConditions(this.previousConditionsStack as unknown as import('../../filters').ColumnConditions[]);
    filters.filter();
  }
  ...
  redo(hot: HotInstance, redoneCallback: HookCallback) {
    ...
    filters.importConditions(this.conditionsStack as unknown as import('../../filters').ColumnConditions[]);
    filters.filter();
  }
}
