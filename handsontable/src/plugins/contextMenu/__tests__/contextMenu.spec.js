describe('ContextMenu', () => {
  ...
  describe('keyboard navigation', () => {
    ...
    describe('item selected', () => {
      ...
      it('should move selection to the first item when it reached the last item position (ARROW_DOWN)', () => {
        handsontable({
          contextMenu: {
            items: {
              item1: {
      ...
      it('should not move selection when there is only one non-disabled item (ARROW_DOWN)', () => {
        handsontable({
          contextMenu: {
            items: {
              item1: {
      ...
      it('should not make any selection when all items are disabled (ARROW_DOWN)', () => {
        handsontable({
          contextMenu: {
            items: {
              item1: {
      ...
      it('should select previous item when user hits ARROW_UP', () => {
        handsontable({
          contextMenu: {
            items: {
              item1: {
      ...
      it('should select previous item (skipping disabled items) when user hits ARROW_UP', () => {
        handsontable({
          contextMenu: {
            items: {
              item1: {
      ...
      it('should select previous item (skipping separators) when user hits ARROW_UP', () => {
        handsontable({
          contextMenu: {
            items: {
              item1: {
      ...
      it('should move selection to the last item when it reached the first item position (ARROW_UP)', () => {
        handsontable({
          contextMenu: {
            items: {
              item1: {
      ...
      it('should not move selection when there is only one non-disabled item (ARROW_UP)', () => {
        handsontable({
          contextMenu: {
            items: {
              item1: {
      ...
      it('should not make any selection when all items are disabled (ARROW_UP)', () => {
        handsontable({
          contextMenu: {
            items: {
              item1: {
    ...
    it('should close main menu when user hits ESC', () => {
      handsontable({
        contextMenu: true,
        height: 100
      });
    ...
    it('should close submenu and parent menu at once after hitting ESC', async() => {
      handsontable({
        contextMenu: true,
        height: 100
      });
