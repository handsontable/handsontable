...
const _predefinedItems: Record<string, () => Record<string, unknown>> = {
...
export function predefinedItems() {
  ...
  objectEach(_predefinedItems, (itemFactory: () => Record<string, unknown>, key: string) => {
 ...
 */
export function addItem(key: string, item: () => Record<string, unknown>) {
