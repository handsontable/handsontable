...
class GhostTable {
  ...
  constructor(hot: HotInstance, nestedHeaderSettingsGetter: Function) {
    this.hot = hot;
  ...
  buildWidthsMap() {
    ...
    for (let column = 0; column < maxColumns; column++) {
      ...
      this.widthsMap.setValueAtIndex(physicalColumnIndex, (columns[column] as HTMLElement).offsetWidth);
    }
   ...
   */
  _buildGhostTable(container: HTMLElement) {
