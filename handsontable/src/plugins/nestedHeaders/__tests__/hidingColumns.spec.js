describe('NestedHeaders', () => {
  ...
  describe('hiding columns', () => {
    ...
    it('should render the setup properly after the table being scrolled', () => {
      ...
      hot.scrollViewportTo(void 0, 40, false, false); // Scroll to column AP4
      hot.render();
      ...
      hot.scrollViewportTo(void 0, 55, false, false); // Scroll to column BD4
      hot.render();
    ...
    it('should allow scrolling (and lazy loading) the columns properly, ' +
      ...
      scrollViewportTo(0, 7, false, false);
