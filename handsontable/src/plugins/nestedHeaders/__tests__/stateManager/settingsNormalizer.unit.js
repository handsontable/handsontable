...
describe('normalizeSettings', () => {
  ...
  it('should normalize user-defined settings with rowspan', () => {
    const settings = [
    ...
    expect(normalizeSettings(settings)).toEqual([
      [
        ...
        createColspanSourceSettings({ l: 'B1', colspan: 2, origColspan: 2 }),
        createPlaceholder(),
      ],
      [
        createColspanSourceSettings({ l: '' }),
        createColspanSourceSettings({ l: 'C1' }),
        createColspanSourceSettings({ l: 'D1' }),
      ],
    ]);
  });

  it('should normalize user-defined settings with both rowspan and colspan', () => {
    const settings = [
    ...
    expect(normalizeSettings(settings)).toEqual([
      [
        createColspanSourceSettings({ l: 'A1', colspan: 2, origColspan: 2, rowspan: 2, origRowspan: 2 }),
        createPlaceholder(),
