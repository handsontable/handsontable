describe('Search plugin', () => {
  ...
  describe('query method', () => {
    ...
    it('should pass search string and cell params to the query method', async() => {
      ...
      expect(customQueryMethod.calls.count()).toEqual(25);
      expect(customQueryMethod.calls.argsFor(0)).toEqual(['A', 'A1', jasmine.objectContaining({
        row: 0,
        col: 0,
        visualRow: 0,
        visualCol: 0,
      ...
      expect(customQueryMethod.calls.argsFor(7)).toEqual(['A', 'C2', jasmine.objectContaining({
        row: 1,
        col: 2,
        visualRow: 1,
        visualCol: 2,
      ...
      expect(customQueryMethod.calls.argsFor(24)).toEqual(['A', 'E5', jasmine.objectContaining({
        row: 4,
        col: 4,
        visualRow: 4,
        visualCol: 4,
