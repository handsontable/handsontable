...
export class Search extends BasePlugin {
  ...
  enablePlugin() {
    ...
    this.addHook('beforeRenderer', (
      td: HTMLTableCellElement, row: number, col: number,
      prop: string | number, value: string, cellProperties: Record<string, unknown>
   ...
   */
  #onBeforeRenderer(TD: HTMLTableCellElement, row: number, col: number, prop: string | number, value: string, cellProperties: Record<string, unknown>) {
    // TODO: #4972
