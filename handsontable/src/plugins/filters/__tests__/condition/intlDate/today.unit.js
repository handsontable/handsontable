import { condition } from 'handsontable/plugins/filters/condition/intlDate/today';
...
describe('Filters condition (`intl_date_today`)', () => {
  const format = {
    year: 'numeric',
    month: '2-digit',
    day: '2-digit'
  ...
  it('should filter matching values', () => {
    ...
    expect(condition(data(dateStringForDay(0)))).toBe(true);
  });
