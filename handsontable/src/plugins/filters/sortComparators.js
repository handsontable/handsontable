 ...
 * @returns {Function}
 */
export function createDateSortComparator(dateFormat) {
  return (a, b) => {
    if (a === '' && b === '') {
      return 0;
    }
 ...
 * @returns {Function}
 */
export function createISODateSortComparator() {
  return (a, b) => {
    if (a === '' && b === '') {
      return 0;
    }
 ...
 */
export function getSortComparatorForMeta(meta) {
  if (!meta) {
    return undefined;
  }

  if (meta.type === 'date') {
    return createDateSortComparator(meta.dateFormat);
  }
