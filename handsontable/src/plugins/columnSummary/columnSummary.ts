...
export class ColumnSummary extends BasePlugin {
  ...
  enablePlugin(): void {
    ...
    this.addHook('afterUpdateSettings', (...args: unknown[]) => (this.#onAfterUpdateSettings as Function)(...args));
    this.addHook('afterLoadData', (...args: unknown[]) => (this.#onAfterLoadData as Function)(...args));
    this.addHook('afterUpdateData', (...args: unknown[]) => (this.#onAfterUpdateData as Function)(...args));
    ...
    this.addHook('beforeRemoveRow',
      (...args: unknown[]) => (this.endpoints!.resetSetupBeforeStructureAlteration as Function)('remove_row', ...args));
