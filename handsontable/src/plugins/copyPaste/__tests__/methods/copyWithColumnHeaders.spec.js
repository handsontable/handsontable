describe('CopyPaste', () => {
  ...
  describe('`copyWithColumnHeaders` method', () => {
    it('should copy the most-bottom column headers with cells to the clipboard', async() => {
      handsontable({
    ...
    it('should copy the most-bottom column headers with cells to the clipboard when all cells and headers are selected', async() => {
      handsontable({
