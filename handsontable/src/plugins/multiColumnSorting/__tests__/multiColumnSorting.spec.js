describe('MultiColumnSorting', () => {
  ...
  it.forTheme('horizon')('should change sorting indicator state when initial column sorting was provided', () => {
    handsontable({
      data: [
        [1, 'Ted', 'Right'],
        [2, '', 'Honest'],
  ...
  it.forTheme('horizon')('cooperation with the ColumnSorting plugin (extra warn and just one plugin works)', () => {
    const warnSpy = spyOn(console, 'warn');
  ...
  it.forTheme('horizon')('cooperation with the ColumnSorting plugin (updateSettings enable and ' +
    'disable plugins properly)', () => {
    handsontable({
      columnSorting: true,
      colHeaders: true
