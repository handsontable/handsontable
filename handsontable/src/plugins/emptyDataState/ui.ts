...
export class EmptyDataStateUI {
  ...
  /**
   * Initializes the empty data state UI with the overlay container and document, then builds and inserts the DOM structure.
   */
  constructor({
    overlayContainer,
    rootDocument,
  }: { overlayContainer: HTMLElement, rootDocument: Document }) {
