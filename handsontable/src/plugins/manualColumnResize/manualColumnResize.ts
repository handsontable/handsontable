...
export class ManualColumnResize extends BasePlugin {
  ...
  setupHandlePosition(TH: HTMLTableHeaderCellElement) {
    ...
    this.#startWidth = Math.trunc(box.width);
  ...
  #onMouseOver(event: MouseEvent) {
    ...
    if (this.checkIfColumnHeader(event.target as HTMLElement)) {
  ...
  #onMouseDown(event: MouseEvent) {
    ...
    if (hasClass(event.target as HTMLElement, 'manualColumnResizer')) {
