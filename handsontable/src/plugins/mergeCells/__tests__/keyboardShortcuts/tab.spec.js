describe('MergeCells keyboard shortcut', () => {
  ...
  describe('"Tab"', () => {
    ...
    it('should navigate forward horizontally through the fully visible merged cells only (header selection)', () => {
      handsontable({
    ...
    it('should navigate forward horizontally through the fully visible merged cells only (header selection, hidden indexes)', () => {
      handsontable({
        data: createSpreadsheetData(11, 11),
        colHeaders: true,
        rowHeaders: true,
