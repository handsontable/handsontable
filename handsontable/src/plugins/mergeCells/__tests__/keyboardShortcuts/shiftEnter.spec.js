describe('MergeCells keyboard shortcut', () => {
  ...
  describe('"Shift + Enter"', () => {
    it('should correctly navigate backward vertically through the merged cells (auto-wrapping is disabled)', async() => {
      handsontable({
    ...
    it('should correctly navigate backward vertically through the merged cells (auto-wrapping is enabled)', async() => {
      handsontable({
        data: createSpreadsheetData(5, 5),
        colHeaders: true,
        rowHeaders: true,
    ...
    it('should correctly navigate backward vertically through the merged cells within the range', async() => {
      handsontable({
      ...
      selection().setRangeFocus(cellCoords(5, 3));
      await keyDownUp(['shift', 'enter']);
    ...
    it('should correctly navigate backward vertically through the merged cells within the multiple ranges', async() => {
      handsontable({
        data: createSpreadsheetData(7, 7),
        colHeaders: true,
        rowHeaders: true,
    ...
    it('should correctly navigate backward vertically through the merged cells within the multiple ranges (selected only merged cells)', async() => {
      handsontable({
        data: createSpreadsheetData(7, 7),
        colHeaders: true,
        rowHeaders: true,
    ...
    it('should correctly navigate backward vertically through two adjacent vertically merged cells', async() => {
      handsontable({
    ...
    it('should correctly navigate backward vertically through two adjacent horizontally merged cells', async() => {
      handsontable({
    ...
    it('should correctly navigate backward vertically through the merged cells within the range (complex example)', async() => {
      handsontable({
    ...
    it('should navigate backward vertically through the fully visible merged cells only (left-to-right column header selection)', async() => {
      handsontable({
    ...
    it('should navigate backward vertically through the fully visible merged cells only (left-to-right column header selection, navigable headers on)', async() => {
      handsontable({
        data: createSpreadsheetData(11, 11),
        colHeaders: true,
        rowHeaders: true,
    ...
    it('should navigate backward vertically through the fully visible merged cells only (right-to-left column header selection)', async() => {
      handsontable({
        data: createSpreadsheetData(11, 11),
        colHeaders: true,
        rowHeaders: true,
    ...
    it('should navigate backward vertically through the fully visible merged cells only (right-to-left column header selection, navigable headers on)', async() => {
      handsontable({
        data: createSpreadsheetData(11, 11),
        colHeaders: true,
        rowHeaders: true,
    ...
    it('should navigate backward vertically through the fully visible merged cells only (top-to-bottom row header selection)', async() => {
      handsontable({
    ...
    it('should navigate backward vertically through the fully visible merged cells only (top-to-bottom row header selection, navigable headers on)', async() => {
      handsontable({
        data: createSpreadsheetData(11, 10),
        colHeaders: true,
        rowHeaders: true,
    ...
    it('should navigate backward vertically through the fully visible merged cells only (bottom-to-top row header selection)', async() => {
      handsontable({
        data: createSpreadsheetData(11, 10),
        colHeaders: true,
        rowHeaders: true,
    ...
    it('should navigate backward vertically through the fully visible merged cells only (bottom-to-top row header selection, navigable headers on)', async() => {
      handsontable({
        data: createSpreadsheetData(11, 10),
        colHeaders: true,
        rowHeaders: true,
