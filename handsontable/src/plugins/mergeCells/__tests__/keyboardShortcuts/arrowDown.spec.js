describe('MergeCells keyboard shortcut', () => {
  ...
  describe('"ArrowDown"', () => {
    ...
    it('should move the cell selection through multiple merged cells', () => {
      handsontable({
    ...
    describe('with autoWrap disabled', () => {
      ...
      it('should NOT move the cell selection to the next column (multiple merged cells)', () => {
        ...
        expect(getSelectedRange()).toEqualCellRange(['highlight: 3,3 from: 3,3 to: 5,5']);
    ...
    describe('with autoWrap enabled', () => {
      ...
      it('should move the cell selection to the first row of the next column (hidden indexes)', () => {
        handsontable({
          data: createSpreadsheetData(5, 5),
          rowHeaders: true,
          colHeaders: true,
      ...
      // fit('should move the cell selection to the first row of the next column (multiple merged cells)', () => {
      //   handsontable({
      //     data: createSpreadsheetData(9, 6),
      //     rowHeaders: true,
      //     colHeaders: true,
      ...
      it('should move the cell selection to the top-left corner, if the most bottom-right cell is selected (navigableHeaders on)', () => {
        handsontable({
          data: createSpreadsheetData(5, 5),
          rowHeaders: true,
          colHeaders: true,
