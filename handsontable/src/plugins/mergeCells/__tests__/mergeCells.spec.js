describe('MergeCells', () => {
  ...
  describe('Undo/Redo', () => {
    ...
    it('should restore a merged cell that was fully contained in a removed row (single-row merge)', async() => {
      handsontable({
    ...
    it('should restore a multi-row merged cell that was fully contained in removed rows', async() => {
      handsontable({
    ...
    it('should preserve a partially-overlapping merged cell across remove + undo (middle row)', async() => {
      handsontable({
        data: createSpreadsheetData(6, 5),
        mergeCells: [
    ...
    it('should restore a merged cell after removing only its top row (partial top overlap)', async() => {
      handsontable({
    ...
    it('should restore a merged cell after removing only its bottom row (partial bottom overlap)', async() => {
      handsontable({
        data: createSpreadsheetData(6, 6),
        mergeCells: [
    ...
    it('should restore multiple fully-removed merged cells from a single row removal', async() => {
      handsontable({
    ...
    it('should remove restored merged cells again on redo', async() => {
      handsontable({
        data: createSpreadsheetData(5, 5),
        mergeCells: [
          { row: 2, col: 1, rowspan: 1, colspan: 3 },
    ...
    it('should restore a merged cell that fully encloses the removed row range', async() => {
      handsontable({
    ...
    it('should restore a mix of fully-removed and partially-overlapping merges from a single multi-row removal', async() => {
      handsontable({
    ...
    it('should restore two partially-overlapping merges that share the removed row', async() => {
      handsontable({
        data: createSpreadsheetData(6, 6),
        mergeCells: [
    ...
    it('should restore + redo a partial-overlap merge consistently', async() => {
      handsontable({
        data: createSpreadsheetData(6, 6),
        mergeCells: [
          { row: 3, col: 4, rowspan: 2, colspan: 2 },
      ...
      expect(plugin.mergedCellsCollection.mergedCells[0].rowspan).toBe(2);
    ...
    it('should preserve cell data inside and around the restored merged area after undo', async() => {
      handsontable({
        data: createSpreadsheetData(5, 5),
        mergeCells: [
          { row: 2, col: 1, rowspan: 1, colspan: 3 },
    ...
    it('should restore `spanned` and `hidden` cell metas on the merged area after undo', async() => {
      handsontable({
        data: createSpreadsheetData(5, 5),
        mergeCells: [
          { row: 2, col: 1, rowspan: 1, colspan: 3 },
    ...
    it('should not throw when removing rows while mergeCells plugin is disabled', async() => {
      handsontable({
        data: createSpreadsheetData(5, 5),
        mergeCells: false,
      });
