...
describe('intlTimeRenderer', () => {
  ...
  describe('registering', () => {
    ...
    it('should register renderer', () => {
      registerRenderer(RENDERER_TYPE, intlTimeRenderer);
  ...
  describe('rendering', () => {
    ...
    it('should insert placeholder if there is no value', () => {
      ...
      intlTimeRenderer(instance, TD, undefined, undefined, undefined, '', cellMeta);
    ...
    it('should replace white spaces with nbsp entity', () => {
      ...
      intlTimeRenderer(instance, TD, undefined, undefined, undefined, 'Long   text ', cellMeta);
    ...
    it('should insert stringified value', () => {
      ...
      intlTimeRenderer(instance, TD, undefined, undefined, undefined, value, cellMeta);
