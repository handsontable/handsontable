describe('DOM helpers', () => {
  // The `observeVisibilityChangeOnce` group was migrated to
  // `tests/e2e/hidden-init-rerender.spec.ts` (DEV-2745) - its `waitForNextAnimationFrames(2)`
  // waits raced IntersectionObserver delivery, which is not frame-bound (DEV-2668's Flake 5).
