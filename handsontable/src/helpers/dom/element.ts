 ...
 */
export function fastInnerHTML(element: HTMLElement, content: string, sanitizeContent: boolean = true): void {
  if (HTML_CHARACTERS.test(content)) {
    element.innerHTML = sanitizeContent ? sanitize(content, undefined) : content;
  } else {
