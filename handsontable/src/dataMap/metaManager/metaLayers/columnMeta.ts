...
export default class ColumnMeta {
   ...
   * @type {GlobalMeta}
   */
  declare globalMeta: { getMetaConstructor(): Function };
  /**
   ...
   * @returns {Function}
   */
  getMetaConstructor(physicalColumn: number) {
   ...
   */
  _createMeta() {
    return (columnFactory(this.globalMeta.getMetaConstructor(), COLUMNS_PROPS_CONFLICTS) as Function & { prototype: Record<string, unknown> }).prototype;
  }
}
