 ...
 */
export function updateCaretPosition(actionName: string, textareaElement: HTMLTextAreaElement | HTMLInputElement) {
  ...
  setCaretPosition(textareaElement, newCaretPosition, newCaretPosition);
}
