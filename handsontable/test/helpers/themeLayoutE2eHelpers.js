 ...
 * Each helper below carries a JSDoc block that names:
 *   - the exact spec file and scenario it represents,
 *   - the meaning of every non-token numeric constant baked into the formula.
 *
