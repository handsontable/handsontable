...
hot.addHookOnce('afterChange', [(changes: Handsontable.CellChange[] | null, source: Handsontable.ChangeSource) => {}]);
hot.alter('insert_row', [[0, 0], [1, 2]], 123, 'source', true);
hot.alter('insert_row', 123, 123, 'source', true);
hot.alter('insert_row');
hot.alter('insert_row_above');
hot.alter('insert_row_below');
hot.alter('insert_col', [[0, 0], [1, 2]], 123, 'source', true);
hot.alter('insert_col', 123, 123, 'source', true);
...
hot.selectAll(true, false, { row: 2 });
hot.selectAll(true, false, { col: 2 });
hot.selectAll(true, false, { row: 1, col: 2 });
