...
import { getNextSortOrder, areValidSortStates, getFullSortConfiguration, warnIfPluginsHaveConflict, warnAboutNotValidatedConfig, getHeaderSpanElement, isFirstLevelColumnHeader } from './utils';
...
var ColumnSorting = function (_BasePlugin) {
  ...
  function ColumnSorting(hotInstance) {
     ...
     * @type {DomHelper}
     */
    _this2.domHelper = new DomHelper(_this2.columnStatesManager);
    /**
  ...
  _createClass(ColumnSorting, [{
    ...
    value: function disablePlugin() {
      ...
      var clearColHeader = function clearColHeader(column, TH) {
        ...
        removeClass(headerSpanElement, _this4.domHelper.getRemovedClasses(headerSpanElement));
      };
    ...
    value: function sort(sortConfig) {
      ...
      var destinationSortConfigs = getFullSortConfiguration(sortConfig).slice(0, 1);
    ...
    value: function sortByPresetSortStates() {
      ...
      mergeSort(indexesWithData, mainSortComparator(arrayMap(sortedColumnsList, function (physicalColumn) {
