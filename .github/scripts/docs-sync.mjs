...
try {
  ...
  // Stage 5: apply. A branch with human commits is left alone.
  if (openPr && syncExists && hasForeignCommits(repoDir, targetRef, syncRef)) {
  ...
  } else if (report.included.length === 0) {
    if (openPr) {
