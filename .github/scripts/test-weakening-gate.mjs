 ...
 * prints a Markdown verdict and always exits 0. It escalates a finding to "flag"
 * when the same change also touches real source (using the presence gate's
 * classifier, which excludes spec/test files).
 *
...
import { detectWeakening, formatFinding, parseNameStatus } from './lib/test-weakening.mjs';
