...
test('the seed calls the shared visual module with the secrets it needs', () => {
  // The seed tier is the one that renders everything the golden records hold
  // and writes `base/develop`; any other tier here would reconcile the baseline
  // down to a subset (visual-tiers.test.mjs pins the tier table itself).
