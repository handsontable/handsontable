...
**The core package (`handsontable/`) is TypeScript.** Source files in `handsontable/src/` are `.ts`. Type definitions in `handsontable/types/` are auto-generated by `tsc --emitDeclarationOnly` (`build:types` script) — do not hand-edit them.
...
- TypeScript typings in `handsontable/types/` are auto-generated — regenerate them with `npm run build:types` after changing source files; do not hand-edit them.
...
| Area | Path |
|---|---|
| TypeScript definitions (auto-generated) | `handsontable/types/` |
