...
| [`specs/`](specs/) | Approved design specs for tooling that spans workflows and scripts. Docs sync: [`2026-09-10-docs-sync-design.md`](specs/2026-09-10-docs-sync-design.md). The docs sync depends on a LiteLLM proxy (secrets `LITELLM_BASE_URL`, `LITELLM_API_KEY`; variable `DOCS_SYNC_MODEL`); its prompt lives at `.github/scripts/lib/docs-sync/prompt.md`. |
