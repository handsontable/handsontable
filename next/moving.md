...
* [Drag and move actions of `manualRowMove` plugin](#drag-and-move-actions-of-manualrowmove-plugin)
...
![dragRows method](../static/img/drag_action.svg)
...
![moveRows method](../static/img/move_action.svg)
