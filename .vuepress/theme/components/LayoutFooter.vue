  ...
  <footer class="footer">
    <div>
      ...
      <div>
        <h4>WRAPPERS</h4>
        <ul>
          <li><a href="/docs/react" rel="noopener">React</a></li>
          <li><a href="/docs/vue" rel="noopener">Vue</a></li>
          <li><a href="/docs/angular" rel="noopener">Angular</a></li>
        </ul>
      </div>
      <div>
        <h4>RESOURCES</h4>
        <ul>
          <li><a href="/docs/Core.html">API Reference</a></li>
          <li><a href="/docs/tutorial-quick-start.html">Tutorials</a></li>
      ...
      <div>
        <h4>SUPPORT</h4>
        <ul>
          <li><a href="//handsontable.com/contact?category=technical_support">Report an issue</a></li>
          <li><a href="//github.com/handsontable/handsontable/issues" rel="noopener">GitHub issues</a></li>
          <li><a href="//forum.handsontable.com" rel="noopener">Developers forum</a></li>
        </ul>
      </div>
      <div>
        <h4>ABOUT</h4>
        <ul>
          ...
          <li><a href="//twitter.com/handsontable" rel="noopener">Twitter</a></li>
          <li><a href="/contact">Contact us</a></li>
          <li><a href="//status.handsontable.com" rel="noopener">Uptime status</a></li>
        </ul>
      </div>
    </div>
  </footer>
