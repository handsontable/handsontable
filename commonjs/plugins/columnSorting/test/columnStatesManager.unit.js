...
describe('ColumnSorting', function () {
  ...
  describe('ColumnStatesManager.setSortStates', function () {
    it('should change state queue', function () {
      var columnStatesManager = new _columnStatesManager.ColumnStatesManager();
      var initialState = (0, _object.deepClone)(columnStatesManager.sortedColumnsStates);

      columnStatesManager.setSortStates([{ column: 0, sortOrder: _columnStatesManager.ASC_SORT_STATE }]);

      var stateAfterFunctionCall = (0, _object.deepClone)(columnStatesManager.sortedColumnsStates);
  ...
  describe('ColumnStatesManager.getSortStates', function () {
    it('should return copy of states', function () {
      var columnStatesManager = new _columnStatesManager.ColumnStatesManager();
      var newStatesQueue = [{ column: 0, sortOrder: _columnStatesManager.DESC_SORT_STATE }, { column: 2, sortOrder: _columnStatesManager.ASC_SORT_STATE }, { column: 1, sortOrder: _columnStatesManager.ASC_SORT_STATE }];
  ...
  describe('ColumnStatesManager.getSortedColumns', function () {
    it('should return list of all sorted columns (respecting the states queue)', function () {
      ...
      columnStatesManager.setSortStates([{ column: 0, sortOrder: _columnStatesManager.DESC_SORT_STATE }, { column: 2, sortOrder: _columnStatesManager.ASC_SORT_STATE }, { column: 1, sortOrder: _columnStatesManager.ASC_SORT_STATE }]);
  ...
  describe('ColumnStatesManager.getNumberOfSortedColumns', function () {
    it('should return number of sorted columns', function () {
      ...
      columnStatesManager.setSortStates([{ column: 2, sortOrder: _columnStatesManager.ASC_SORT_STATE }, { column: 1, sortOrder: _columnStatesManager.ASC_SORT_STATE }]);
  ...
  describe('ColumnStatesManager.isColumnSorted', function () {
    it('should return if particular column is sorted', function () {
      ...
      columnStatesManager.setSortStates([{ column: 1, sortOrder: _columnStatesManager.ASC_SORT_STATE }]);
  ...
  describe('ColumnStatesManager.getSortOrderOfColumn', function () {
    ...
    it('should return proper order when column is sorted', function () {
      var columnStatesManager = new _columnStatesManager.ColumnStatesManager();
      columnStatesManager.setSortStates([{ column: 0, sortOrder: _columnStatesManager.DESC_SORT_STATE }, { column: 1, sortOrder: _columnStatesManager.ASC_SORT_STATE }]);

      expect(columnStatesManager.getSortOrderOfColumn(0)).toEqual(_columnStatesManager.DESC_SORT_STATE);
      expect(columnStatesManager.getSortOrderOfColumn(1)).toEqual(_columnStatesManager.ASC_SORT_STATE);
    });
  });
});