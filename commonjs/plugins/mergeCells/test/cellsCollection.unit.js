...
describe('MergeCells', function () {
  describe('MergedCellsCollection', function () {
    var hotMock = {
    ...
    describe('`add` method', function () {
      it('should add a merged cell object to the array of merged cells', function () {
        var mergedCellsCollection = new _cellsCollection2.default({ hot: hotMock });
      ...
      it('should not add new merged cells and throw an appropriate warning, if the merged cell is overlapping any other ' + 'previously declared merged cell', function () {
        ...
        expect(warnSpy).toHaveBeenCalledWith(_cellsCollection2.default.IS_OVERLAPPING_WARNING(newMergedCells[1]));
    ...
    describe('`remove` method', function () {
      it('should remove a merged cell object from the array of merged cells by passing the starting coordinates', function () {
        var mergedCellsCollection = new _cellsCollection2.default({ hot: hotMock });
      ...
      it('should remove a merged cell object from the array of merged cells by passing the coordinates from the middle of the merged cell', function () {
        var mergedCellsCollection = new _cellsCollection2.default({ hot: hotMock });
    ...
    describe('`get` method', function () {
      it('should get a merged cell object from the array of merged cells by passing the starting coordinates', function () {
        var mergedCellsCollection = new _cellsCollection2.default({ hot: hotMock });
        ...
        var wantedCollection = mergedCellsCollection.get(10, 11);
      ...
      it('should get a merged cell object from the array of merged cells by passing coordinates from the middle of the merged cell', function () {
        var mergedCellsCollection = new _cellsCollection2.default({ hot: hotMock });
        ...
        var wantedCollection = mergedCellsCollection.get(12, 13);
    ...
    describe('`getByRange` method', function () {
      it('should get a merged cell object from the array of merged cells by passing coordinates from the middle of the merged cell', function () {
        var mergedCellsCollection = new _cellsCollection2.default({ hot: hotMock });
        ...
        var wantedCollection = mergedCellsCollection.getByRange({
          from: {
            row: 12,
            col: 12
          },
    ...
    describe('`getWithinRange` method', function () {
      it('should get an array of merged cells within the provided range', function () {
        var mergedCellsCollection = new _cellsCollection2.default({ hot: hotMock });
        ...
        var wantedCollections = mergedCellsCollection.getWithinRange({
          from: {
            row: 0,
            col: 0
          },
    ...
    describe('`shiftCollections` method', function () {
      it('should shift all the appropriate merged cells in the provided direction', function () {
        var mergedCellsCollection = new _cellsCollection2.default({ hot: hotMock });
      ...
      it('should resize the merged cell (and shift the merged cells that follow) if the change happened inside a merged cell', function () {
        var mergedCellsCollection = new _cellsCollection2.default({ hot: hotMock });
    ...
    describe('`isOverlapping` method', function () {
      it('should return whether the provided merged cell overlaps with the others in the merged cell', function () {
        var mergedCellsCollection = new _cellsCollection2.default({ hot: hotMock });
