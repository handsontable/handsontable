...
const UMD_MIN_JS_PATH = path.resolve(`${DIST_PATH}/bundles/tmp-hot-angular.umd.min.js`);
const UMD_JS_PATH = path.resolve(`${DIST_PATH}/bundles/tmp-hot-angular.umd.js`);
