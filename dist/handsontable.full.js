...
(function (window, Handsontable) {
                ...
                if (changes[i] === null) {
                    ...
                    if (cellProperties.type === 'numeric' && typeof changes[i][3] === 'string') {
                        if (changes[i][3].length > 0 && (/^-?[\d\s]*(\.|\,)?\d*$/.test(changes[i][3]) || cellProperties.format)) {
                            ...
                            changes[i][3] = numeral().unformat(changes[i][3] || '0').toFixed(7); //Added toFixed SR                            
                        }
                    }
    ...
    (function (Handsontable) {
        ...
        Handsontable.DataMap.prototype.createRow = function (index, amount, createdAutomatically) {
            ...
            var actionWasNotAdded = Handsontable.hooks.execute(this.instance, 'beforeCreateRow', index, amount);//STEFANO
            if (actionWasNotAdded === false) {
                return;
            }//STEFANO
        ...
        function HandsontableManualColumnResize() {
            ...
            function setupHandlePosition(TH) {
                ...
                if (col >= 0) { //if not row header
                    ...
                    startWidth = currentTH.width == "" ? 0 : parseInt(currentTH.width, 10);
                    handle.style.top = box.top + 'px';
    ...
    (function (Handsontable) {
        Handsontable.UndoRedo = function (instance) {
            ...
            instance.addHook("beforeCreateRow", function (index, amount) {
                var originalData = plugin.instance.getData();
                index = (originalData.length + index) % originalData.length;
                var removedData = originalData.slice(index, index + amount);
                var action = new Handsontable.UndoRedo.RemoveRowAction(index, removedData);
    ...
    WalkontableTable.prototype.draw = function (fastDraw) {
        ...
        if (!fastDraw) {
            ...
            if (this.instance.cloneOverlay instanceof WalkontableDebugOverlay
                ...
                /*
                * lE 28/01/2015: library bug fixing
                *
                * renderStartRow = this.instance.wtViewport.rowsPreCalculator.renderStartRow;
                *
                */

                if (this.instance.wtViewport.rowsPreCalculator) {
                    renderStartRow = this.instance.wtViewport.rowsPreCalculator.renderStartRow;
                } else {
                    renderStartRow = 0;
                }
    ...
    WalkontableTable.prototype.getRenderedColumnsCount = function () {
        ...
        if (isClone && (this.instance.cloneOverlay instanceof WalkontableHorizontalScrollbarNative || this.instance.cloneOverlay instanceof WalkontableCornerScrollbarNative)) {
            ...
            */
            ...
            var columnStrategy = this.getColumnStrategy();

            return columnStrategy ? columnStrategy.cellCount : 0;
        }
    };
    ...
    WalkontableTable.prototype.getRenderedRowsCount = function () {
        ...
        */
        ...
        return this.instance.wtViewport.rowsPreCalculator ? this.instance.wtViewport.rowsPreCalculator.countRendered : 0;
    };
    ...
    WalkontableTableRenderer.prototype.render = function () {
        ...
        var visibleColIndex
          ...
          , cloneLimit = this.instance.wtViewport.rowsPreCalculator ? this.instance.wtViewport.rowsPreCalculator.countRendered : 0;
