describe('Core_reCreate', () => {
  ...
  it('should correctly re-render corner header when there is multiline content', () => {
    ...
    // 14.3px x 2 => 28.6px (Chrome will round it to 28px)
    ...
    // div.relative has 36px in Chrome and 35.95px (rounded to 36px) in Firefox and IE
    // th adds 1px of top border
    expect(getTopLeftClone().height()).toBe(37);
  });
});
