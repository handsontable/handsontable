...
const testArrayToHTML: string = Handsontable.helper.arrayToString([[]]);
...
const testInstanceToString: string = Handsontable.helper.instanceToString(new Handsontable(document.createElement('div'), {}));
...
const testTableToSettings: Handsontable.GridSettings = Handsontable.helper.tableToSettings('');
const testTableToSettings2: Handsontable.GridSettings = Handsontable.helper.tableToSettings(document.createElement('table'));
