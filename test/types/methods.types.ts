...
const autoColumnSize: typeof Handsontable.plugins.AutoColumnSize = hot.getPlugin('autoColumnSize');
...
const autoRowSize: typeof Handsontable.plugins.AutoRowSize = hot.getPlugin('autoRowSize');
const autofill: typeof Handsontable.plugins.Autofill = hot.getPlugin('autofill');
const bindeRowsWithHeaders: typeof Handsontable.plugins.BindRowsWithHeaders = hot.getPlugin('bindRowsWithHeaders');
const collapsibleColumns: typeof Handsontable.plugins.CollapsibleColumns = hot.getPlugin('collapsibleColumns');
const columnSorting: typeof Handsontable.plugins.ColumnSorting = hot.getPlugin('columnSorting');
const columnSummary: typeof Handsontable.plugins.ColumnSummary = hot.getPlugin('columnSummary');
const comments: typeof Handsontable.plugins.Comments = hot.getPlugin('comments');
const contextMenu: typeof Handsontable.plugins.ContextMenu = hot.getPlugin('contextMenu');
const copyPaste: typeof Handsontable.plugins.CopyPaste = hot.getPlugin('copyPaste');
const customBorders: typeof Handsontable.plugins.CustomBorders = hot.getPlugin('customBorders');
const dragToScroll: typeof Handsontable.plugins.DragToScroll = hot.getPlugin('dragToScroll');
const dropdownMenu: typeof Handsontable.plugins.DropdownMenu = hot.getPlugin('dropdownMenu');
const exportFile: typeof Handsontable.plugins.ExportFile = hot.getPlugin('exportFile');
const filters: typeof Handsontable.plugins.Filters = hot.getPlugin('filters');
const hiddenColumns: typeof Handsontable.plugins.HiddenColumns = hot.getPlugin('hiddenColumns');
const hiddenRows: typeof Handsontable.plugins.HiddenRows = hot.getPlugin('hiddenRows');
const manualColumnFreeze: typeof Handsontable.plugins.ManualColumnFreeze = hot.getPlugin('manualColumnFreeze');
const manualColumnMove: typeof Handsontable.plugins.ManualColumnMove = hot.getPlugin('manualColumnMove');
const manualColumnResize: typeof Handsontable.plugins.ManualColumnResize = hot.getPlugin('manualColumnResize');
const manualRowMove: typeof Handsontable.plugins.ManualRowMove = hot.getPlugin('manualRowMove');
const manualRowResize: typeof Handsontable.plugins.ManualRowResize = hot.getPlugin('manualRowResize');
const mergeCells: typeof Handsontable.plugins.MergeCells = hot.getPlugin('mergeCells');
const multiColumnSorting: typeof Handsontable.plugins.MultiColumnSorting = hot.getPlugin('multiColumnSorting');
const nestedHeaders: typeof Handsontable.plugins.NestedHeaders = hot.getPlugin('nestedHeaders');
const persistentState: typeof Handsontable.plugins.PersistentState = hot.getPlugin('persistentState');
const search: typeof Handsontable.plugins.Search = hot.getPlugin('search');
const trimeRows: typeof Handsontable.plugins.TrimRows = hot.getPlugin('trimRows');
const formulas: typeof Handsontable.plugins.Formulas = hot.getPlugin('formulas');
const nestedRows: typeof Handsontable.plugins.NestedRows = hot.getPlugin('nestedRows');
