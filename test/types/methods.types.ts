...
hot.setSourceDataAtRowProp(0, 'foo', 'foo');
hot.setSourceDataAtRowProp([[1, 'foo', 'foo']]);
...
hot.rowIndexMapper.getNotSkippedIndexes(false);
hot.rowIndexMapper.getNotSkippedIndexes(true);
hot.rowIndexMapper.getNotSkippedIndexesLength();
...
hot.columnIndexMapper.getNotSkippedIndexes(false);
hot.columnIndexMapper.getNotSkippedIndexes(true);
hot.columnIndexMapper.getNotSkippedIndexesLength();
hot.columnIndexMapper.getNumberOfIndexes();
hot.columnIndexMapper.moveIndexes(0, 1);
hot.columnIndexMapper.moveIndexes([0], 1);
hot.columnIndexMapper.isSkipped(0);
