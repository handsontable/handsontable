describe('HandsontableObserveChanges', function () {
  ...
  describe("refreshing table after changes have been detected", function () {  it('should render newly added row', function () {
  ...
  describe("enabling/disabling plugin", function () {  it("should be possible to enable plugin using updateSettings", function () {
    var data = createSpreadsheetData(2, 2);
  ...
  describe('observeChanges fires appropriate events when changes are detected', function(){
    ...
    it("should fire afterRemoveRow event after detecting that multiple rows have been removed", function () {
      ...
      runs(function(){
        ...
        expect(afterRemoveRowCallback.calls[0].args).toEqual([0, 1, undefined, undefined, undefined]);
        expect(afterRemoveRowCallback.calls[0].args).toEqual([0, 1, undefined, undefined, undefined]);
      });
    });
    ...
    it("should fire afterRemoveCol event after detecting that multiple cols have been removed", function () {
      ...
      runs(function(){
        ...
        expect(afterRemoveColCallback.calls[1].args).toEqual([1, 1, undefined, undefined, undefined]);
        expect(afterRemoveColCallback.calls[0].args).toEqual([0, 1, undefined, undefined, undefined]);
      });
    });
