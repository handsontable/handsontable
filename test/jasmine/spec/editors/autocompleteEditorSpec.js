describe('AutocompleteEditor', function () {
  ...
  describe("choices", function () {
    ...
    it('should NOT throw any exceptions after a key is pressed in the input area', function () {
      var hot = handsontable({
        columns: [
          {
            editor: 'autocomplete',
  ...
  xit("should be chosen first value from choice list to selected cell after hit TAB button", function () {
    var hot = handsontable({
      data: [
        ["Nissan", 2009, "", "black"],
  ...
  xit("should be chosen first value from choice list to selected cell after hit ENTER button", function () {
    var hot = handsontable({
      data: [
        ["Nissan", 2009, "", "black"],
        ["Nissan", 2006, "blue", "blue"],
