describe('GhostTable', function () {
  ...
  describe('row', function() {
    ...
    it('should get valid heights', function () {
      ...
      expect(heightSpy.calls.argsFor(0)[1]).toBeAroundValue(23);
      expect(heightSpy.calls.argsFor(1)[0]).toBe(1);
      expect(heightSpy.calls.argsFor(1)[1]).toBeAroundValue(64);
      expect(heightSpy.calls.argsFor(2)[0]).toBe(2);
      expect(heightSpy.calls.argsFor(2)[1]).toBeAroundValue(43);
    });
  });
  ...
  describe('column', function() {
    ...
    it('should get valid widths', function () {
      ...
      expect(widthSpy.calls.argsFor(0)[1]).toBeAroundValue(85, 6);
      expect(widthSpy.calls.argsFor(1)[0]).toBe(1);
      expect(widthSpy.calls.argsFor(1)[1]).toBeAroundValue(39, 6);
      expect(widthSpy.calls.argsFor(2)[0]).toBe(2);
      expect(widthSpy.calls.argsFor(2)[1]).toBeAroundValue(67, 6);
    });
  });
